...
<div style="text-align:center;padding:16px;font-size:11px;color:#6b7280">
  ...
  <div style="margin-top:12px"><a href="https://px.a8.net/svt/ejp?a8mat=4BCFNO+BB8IK2+5W1M+BXB8X" rel="nofollow"><img src="https://www29.a8.net/svt/bgt?aid=260920644684&wid=001&eno=01&mid=s00000027481002003000&mc=1" alt="ふるいち トレカ宅配買取" border="0" width="300" height="250" loading="lazy" decoding="async" style="max-width:100%;height:auto"></a><img src="https://www13.a8.net/0.gif?a8mat=4BCFNO+BB8IK2+5W1M+BXB8X" alt="" border="0" width="1" height="1"></div>
</div>
<div class="ft">
