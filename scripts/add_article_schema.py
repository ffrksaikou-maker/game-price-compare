...
ARTICLES = [
    {
        ...
        "headline": "ポケカ買取10店舗の特徴を徹底比較",
        "description": "ポケカBOX買取に対応した10店舗の特徴を比較。森森買取・買取ホムラ・買取一丁目など、各店舗の強みや対応方法を解説。",
        ...
        "faq": [
            {
                ...
                "a": "2026年4月時点で、森森買取・買取ホムラ・買取一丁目・ラントゥ買取・買取ソムリエ・海峡通信・買取オク・買取ルデヤの10店舗を掲載しています。すべての店舗から毎日3回(11:00/15:00/18:00)自動で価格を取得しています。"
            },
            {
            ...
            },
            {
                ...
                "a": "店頭買取は即日現金化できますが、店舗が近くにないと使えません。郵送買取は全国対応で送料無料キャンペーンを行う店舗も多いです。10店舗すべてが郵送買取に対応しています。"
            },
            {
                "q": "買取金額に差が出る理由は?",
    ...
    },
    {
        ...
        "faq": [
            ...
            {
                "q": "結局どれが一番お得?",
                "a": "手取り最大化を優先するならスニダン > メルカリ > 買取店 の順です。ただし、急ぎで現金化したい・手間を掛けたくない場合は買取店が最適です。ポケカ買取チェッカーで10店舗を比較すれば、買取店の中で最高値を即座に見つけられます。"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "description": "2026年3月のポケカ未開封BOX買取価格の値上がりランキング。151が約+1万円で1位、MEGAドリームexが+33.3%の上昇率トップ。10店舗の実データに基づく月間レポート。",
