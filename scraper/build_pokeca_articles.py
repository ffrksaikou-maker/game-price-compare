...
POKECA_ARTICLES: list[dict] = [
 ...
 'body': '<p>未開封BOXの買取は<strong>シュリンクが付いたまま</strong>であることが前提になります。ただ「剥がすと実際いくら落ちるのか」は、両方の価格を出している店の価格表を見ないと分かりません。</p>\n'
         ...
         '50L</a></strong><br>ロックできるフタが付いた折りたたみコンテナです。実際に詰めてみると<strong>通常BOXで55〜58箱、ハイクラスパックで90〜94箱</strong>入りました。半透明で中身が見え、使わないときは畳めます。積み重ねられるので、床から上げる用途にも向きます。</div></div><ul>\n'
