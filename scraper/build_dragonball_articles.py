...
<p>ブースターパック第11弾です。1パック220円×24パックで、<strong>BOX定価は5,280円</strong>。FB-10「CROSS FORCE」(2026年6月13日)に続く弾で、<strong>従来価格で発売される最後のブースター</strong>にあたります。</p>
...
<tbody>
<tr><td>2025年12月13日</td><td>FB-08</td><td>誇り高き戦闘民族</td></tr>
<tr><td>2026年3月14日</td><td>FB-09</td><td>DUAL EVOLUTION</td></tr>
<tr><td>2026年6月13日</td><td>FB-10</td><td>CROSS FORCE</td></tr>
...
def _nav_links(current_slug: str) -> str:
    ...
    for h in HOWTO_ARTICLES:
        ...
        items.append(f'<a href="{h["slug"]}.html"{cls}>{_esc(h["nav_label"])}</a>')
    return (
        '<div class="article-nav-title">📰 買取ガイド</div>\n'
        + "\n".join(items)
        + '\n<a class="article-nav-more" href="/dragonball">BOX買取価格を比較する</a>'
    )
...
<h2>関連ページ</h2>
<ul>
<li><a href="/dragonball">ドラゴンボールBOX買取価格比較トップ</a> — 全BOXの買取価格を店舗横断で比較(毎日更新)</li>
</ul>
