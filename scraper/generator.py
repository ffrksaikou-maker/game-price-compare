...
BLOG_ARTICLES = [
    ...
    {"url": "rgb-mew-guide.html", "title": "RGBミュウはなぜ50万円なのか｜3色の価格差・封入率・BOX期待値を検証", "desc": "30th CELEBRATIONの隠しレア「RGBミュウ」を実データで検証。買取は赤¥508,300・青¥389,300・緑¥380,800で赤と緑では12.7万円差、同じ赤でも晴れる屋2¥700,000と駿河屋¥598,000で10万円以上開く。高額化の4つの理由、よく引用される「120BOXに1枚」が発売日のサンプル1本の観測にすぎず統計的には21.5〜4,739BOXに1枚まで振れること、そこから逆算したBOX1箱あたりの期待値が定価の1.3%〜275%と判断材料にならないことまで数字で整理。", "date": "2026-09-24"},
...
def _update_sitemap(
    ...
    static_pages = [
        ...
        ("/rgb-mew-guide.html", "monthly", "0.9", "2026-09-24"),
