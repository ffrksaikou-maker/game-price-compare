...
BLOG_ARTICLES = [
    {"url": "box-hokan.html", "title": "ポケカBOXの保管方法｜シュリンクを剥がすと買取はいくら落ちるか", "desc": "シュリンク付きとシュリンクなしの買取価格を38商品ぶん集計。下落率の平均は12.3%、最大はポケモンカード151の9,000円で、弾によって-2.7%から-24.4%まで開きます。湿気による反り、2026年8月の記録的大雨をふまえた置き場所のリスク、BOXローダーや防湿庫まで実データで整理。", "date": "2026-09-11"},
    {"url": "chusen-matome.html", "title": "ポケカBOX 抽選販売まとめ｜当たったら定価からいくら得か", "desc": "Amazonの招待リクエスト(抽選)を受け付けている商品を一覧化し、当サイトが最大10店舗から毎日自動収集している定価と買取実データの差額を並べて掲載。抽選をやっている店舗の特徴と、応募する価値の判断材料までまとめています。", "date": "2026-09-08"},
    ...
    {"url": "shop-price-gap.html", "title": "同じBOXでも店で買取価格はどれだけ違うか", "desc": "10店舗の実データで52商品の最高値と最安値を比較。差額の中央値は1,800円、最大17,000円。しかも最高値を出す店は1店に固定されず商品ごとに入れ替わるため、商品単位での比較が必要。", "date": "2026-08-26"},
    {"url": "box-age-multiple.html", "title": "ポケカBOXは発売から何年で何倍になるか", "desc": "10店舗の実データで経過年数と定価比の関係を68商品ぶん集計。発売直後2.11倍→1年で4.22倍→2年目に2.69倍まで下げ、そこから年を追って上昇。買い時の考え方と生存バイアスの限界まで整理。", "date": "2026-08-26"},
    {"url": "box-price-trend.html", "title": "ポケカBOX相場の値動きレポート｜上がる弾・下がる弾", "desc": "10店舗の実データで全BOXの値動きを横断集計。長期では大きくプラスでも直近を切り取ると逆になるなど、期間の取り方で結論が変わる点を実測値で解説。ワンピースカードとの同期間比較も掲載。", "date": "2026-08-26"},
    ...
    {"url": "vstar-universe-atari-guide.html", "title": "VSTARユニバース 当たりカードランキング｜1位は最高レアではなくピカチュウAR", "desc": "ハイクラスパック「VSTARユニバース」の当たりカードランキングと封入率。最高額は最高レアリティのURではなくピカチュウ AR(買取約40,000円)で、約250BOXに1パックといわれるAR9枚セット由来です。上位10枚すべてが4,500円以上という層の厚さはハイクラスパック随一。BOX買取は9店舗最高¥31,000(定価×5.64)で、最高値と最安値の差は1.11倍と当サイト追跡BOXでもとくに小さく、絶版から3年で相場が固まったことを示します。", "date": "2026-08-11"},
    ...
    {"url": "paradigm-trigger-atari-guide.html", "title": "パラダイムトリガー 当たりカードランキング｜ルギアV SAは約12万円", "desc": "拡張パック「パラダイムトリガー」の当たりカードランキングと封入率。ルギアV SA(買取約120,000円)が突出し、2位ルギアVSTAR UR(約5,500円)とは約21.8倍という当サイト屈指の断崖。上位10枚のうち6枚がルギア関連という一強集中型です。BOX買取は6店舗最高¥21,500(定価×4.34)、カード/BOX比5.58倍でMURを持たないS&S弾としては異例の中身牽引型です。", "date": "2026-08-11"},
    {"url": "opened-card-selling.html", "title": "開封済みポケカの売り先｜当たりは鑑定・専門店、はずれはまとめ売り", "desc": "開封済みポケモンカードの売却先を価値ごとに整理しました。1BOX開けると140〜210枚残りますが、数千円以上になるのは多くて2〜3枚。PSA鑑定は1枚5,000〜10,000円のコストがかかるため未鑑定1万円以上が目安、1,000〜10,000円は買取専門店やフリマで個別に、単価数十円が数百枚あるなら仕分け不要の宅配買取でまとめ売り。手数料と手間の実数で線引きを解説します。", "date": "2026-08-12"},
    {"url": "violet-ex-atari-guide.html", "title": "バイオレットex 当たりカードランキング｜同日発売ペアで唯一「型」が分かれた弾", "desc": "拡張パック「バイオレットex」(SV1V)の当たりカードランキングと封入率。最高額は看板のミライドンex SAR(約4,000円)ではなくミモザ SAR(約8,500円)。BOX買取は8店舗最高¥11,500(定価×2.13)、カード/BOX比0.74倍の希少性牽引型です。同日発売のスカーレットex(1.46倍)とは、当サイト追跡の同日ペア6組で唯一型が分かれました。2位以下の合計はほぼ互角で、差を作ったのは1位の1枚だけです。", "date": "2026-08-12"},
    {"url": "dx-vs-normal-guide.html", "title": "拡張パックDXと通常版はどちらを買うべきか｜定価も枚数も同じなのに買取だけが違う", "desc": "ブラックボルト・ホワイトフレアの拡張パックDX(デラックス)と通常版を実データで比較。定価はどちらも¥5,800、1BOXの総カード枚数も140枚、封入率も同じで、違うのはパックの分け方(7枚×20 / 35枚×4)とAR確定枚数だけ。それでも買取はDX版が高く、ブラックボルトで+¥2,300、ホワイトフレアで+¥300の差がついています。目的別にどちらを選ぶべきか整理しました。", "date": "2026-08-12"},
    {"url": "star-birth-atari-guide.html", "title": "スターバース 当たりカードランキング｜看板を抑えた1位はリザードンV SA 約3万円", "desc": "拡張パック「スターバース」の当たりカードランキングと封入率。VSTARが初登場した弾で看板はアルセウスVSTARですが、買取最高額はリザードンV SA(約30,000円)。看板のアルセウスV SA(約8,000円)の約3.75倍で、上位10枚のリザードン3枚(約46,000円)がアルセウス4枚(約13,600円)を約3.4倍上回ります。BOX買取は5店舗最高¥20,500(定価×4.14)、カード/BOX比1.46倍の中身牽引型です。", "date": "2026-08-12"},
    {"url": "battle-region-atari-guide.html", "title": "バトルリージョン 当たりカードランキング｜カード1位1枚とBOX1箱がほぼ同額", "desc": "強化拡張パック「バトルリージョン」の当たりカードランキングと封入率。最高額はスターミーV CSR(約13,000円)で、BOX買取¥12,400とほぼ同額のカード/BOX比1.05倍。2位ガブリアスV CSR(約7,500円)から3位ツツジ SR(約1,000円)へ7.5倍の断崖があり、ヒスイ地方の弾でありながらカスミ・シロナが描かれたCSRが上位を独占しています。", "date": "2026-08-12"},
    {"url": "incandescent-arcana-atari-guide.html", "title": "白熱のアルカナ 当たりカードランキング｜1位はポケモンではなくセレナ SR", "desc": "強化拡張パック「白熱のアルカナ」の当たりカードランキングと封入率。最高額はポケモンではなくサポートのセレナ SR(約6,000円)で、上位10枚のうち4枚をトレーナーズが占め、合計額(約12,300円)でポケモン6枚(約9,600円)を上回ります。BOX買取は6店舗最高¥11,400(定価×2.30)で2022年のS&S全9弾では最安、カード/BOX比0.53倍の希少性牽引型です。", "date": "2026-08-12"},
    {"url": "dark-phantasma-atari-guide.html", "title": "ダークファンタズマ 当たりカードランキング｜カードは5,000円なのにBOXは¥28,500", "desc": "強化拡張パック「ダークファンタズマ」の当たりカードランキングと封入率。最高額はピカチュウ CHR(買取約5,000円)で上位10枚すべてが5,000円以下という控えめな水準ですが、BOX買取は¥28,500(定価×5.76)に達しています。カード/BOX比0.18倍という極端な希少性牽引型で、中身の相場ではなく未開封BOXの残存数が価格を作っている典型例です。", "date": "2026-08-11"},
    ...
    {"url": "monthly-ranking-2026-06.html", "title": "【2026年6月】ポケカBOX買取 月間値上がりランキング", "desc": "2026年6月のポケカ未開封BOX買取 値上がりランキング。現役シリーズで上昇したのはクレイバースト(+¥400)とムニキスゼロ(+¥200)の2銘柄のみという静かな月でした。10店舗の実データで集計し、S&S(旧)は参考TOP5として別枠掲載。", "date": "2026-07-01"},
    {"url": "monthly-ranking-2026-05.html", "title": "【2026年5月】ポケカBOX買取 月間値上がりランキング", "desc": "2026年5月のポケカ未開封BOX買取 値上がりランキング。上昇はスペシャルBOX トウホク(+¥500)・ナイトワンダラー(+¥400)・古代の咆哮(+¥300)と小幅で、相場が凪いだ月でした。10店舗の実データで集計し、S&S(旧)は参考TOP5として別枠掲載。", "date": "2026-06-01"},
    ...
    {"url": "erika-sar-guide.html", "title": "エリカの招待SARの買取価格と相場推移", "desc": "買取¥5,000・PSA10で¥27,500。初動¥128,200からの推移と、親BOX151が+70%上がった局面でカードは+26%、BOXが-25%下げた局面ではカードが-47%という「上げに鈍く下げにきつい」連動を実データで検証。", "date": "2026-09-03"},
    ...
    {"url": "30th-celebration-forecast.html", "title": "【9/16発売】30th CELEBRATION BOX3種の相場予想｜1年後・3年後・5年後", "desc": "ポケカ30周年「30th CELEBRATION」の抽選対象BOX3種(拡張パックBOX 定価¥7,200/FUTURISTIC BOX ¥27,500/プレミアムデッキセット エーフィ・ブラッキー ¥6,200)の相場を発売前予想。25周年商品の実績(25thコレクションが当サイト実データで定価×13.09、GOLDEN BOXが最大×15)を土台に、発売直後・1年後・3年後・5年後を3シナリオで算出。ポケモンセンターオンラインの追加抽選は8月31日16:59で受付終了、当選発表は9月4日15:00以降(対象は拡張パックBOX・プレミアムデッキセット・カードセット9種、FUTURISTIC BOXは対象外)。発売は9月16日世界同時。", "date": "2026-08-11"},
    {"url": "30th-celebration-review.html", "title": "【答え合わせ】30th CELEBRATIONは3商品とも中立予想が的中・発売1週間で+32%", "desc": "2026-09-16発売の30周年記念3商品の初動を、8月公開の3シナリオ予想と10店舗実データで答え合わせ。拡張パックBOX¥27,000(中立比-3.6%)、FUTURISTIC BOX¥73,000(+4.3%)、プレミアムデッキセット¥18,000(±0%)と全商品が中立シナリオの±5%に着地。ストームエメラルダ(-33%)やアビスアイ(-25%)が発売7日→30日で下げたのと正反対に30thだけ+32%上昇した理由、FUTURISTIC BOXの店舗差2.35倍(¥42,000)、9/30の抽選結果発表・10/16のカードセット発売を控えた今後の展望を解説。", "date": "2026-09-22"},
    {"url": "30th-celebration-atari-guide.html", "title": "30th CELEBRATION(M6a) 当たりカードランキング｜FUR・SARの相場と封入率", "desc": "ポケカ30周年記念パック「30th CELEBRATION」の当たりカードランキングを発売当日の実データで掲載。1位ミュウex FUR ¥32,800、2位ミュウツーex FUR ¥27,800、3位ルギア(30周年復刻) ¥17,800。FURは約5BOXに1枚・全2種のため狙いの1種は約10BOX(定価¥72,000)必要で、シングル買いの約2.2倍かかります。BOX買取は最高¥20,000(定価の2.78倍)で、金額だけなら未開封のまま売る方が有利という計算も実データで示します。1パック6枚のうちピカチュウと基本エネルギーの2枚が確定枠という特殊構成、SAR1BOXに1枚・30周年復刻1BOXに2枚の封入率も整理。", "date": "2026-09-16"},
    ...
    {"url": "scarlet-ex-atari-guide.html", "title": "スカーレットex 当たりカードランキング・封入率完全ガイド", "desc": "SVシリーズ第1弾「スカーレットex」(SV1S)の当たりカードランキングを解説。看板サーナイトex SAR(買取約2.2万円)が2位コライドンex SAR(約5,000円)に4.4倍差の一強。基本闘エネルギー UR(約2,200円)とネストボール UR(約1,500円)が3位・5位に入るSV初期特有の構造、同日発売バイオレットexとの31%の相場差も実データで整理。", "date": "2026-08-10"},
    ...
    {"url": "startdeck100-atari-guide.html", "title": "スタートデッキ100 当たり番号一覧・見分け方完全ガイド", "desc": "スタートデッキ100「バトルコレクション」の当たり番号一覧・見分け方・封入率を解説。最高当たりNo.001(金)メガリザードンYex MUR約70万円、No.025ピカチュウex SAR・No.032リーリエのピッピex SAR・隠しNo.101 ZA御三家SARまで。開封前は見分け不可の理由と開封後のチェック法、全ミラー確率(約12%)も整理。", "date": "2026-08-31"},
    ...
    {"url": "mega-brave-atari-guide.html", "title": "メガブレイブ 当たりカードランキングと封入率", "desc": "MURは50BOXに約1枚、SARは6BOXに1枚でも全5種のため狙いの1枚は約30BOX。リーリエの決心SAR(買取約23,000円)の自引きは定価換算で約16万円かかり、シングル買いの約7倍という検証まで掲載。", "date": "2026-07-12"},
    ...
    {"url": "terastal-fes-ex-atari-guide.html", "title": "テラスタルフェスex 当たりカードランキングと封入率", "desc": "ポケモンSARは1BOXに1枚確定でも全33種のため狙いの1枚は約3.76%(約27BOX)。ブラッキーex SARの自引きは定価換算約15万円、マスターボールミラーの狙い撃ちは約111万円=カード相場の約79倍という検証まで掲載。", "date": "2026-07-26"},
...
def _build_box_narrative(
    ...
    atari_links = {
        ...
        "vstar-universe": ("vstar-universe-atari-guide.html", "VSTARユニバース 当たりカードランキング・封入率完全ガイド"),
        ...
        "paradigm-trigger": ("paradigm-trigger-atari-guide.html", "パラダイムトリガー 当たりカードランキング・封入率完全ガイド"),
        "dark-phantasma": ("dark-phantasma-atari-guide.html", "ダークファンタズマ 当たりカードランキング・封入率完全ガイド"),
        "star-birth": ("star-birth-atari-guide.html", "スターバース 当たりカードランキング・封入率完全ガイド"),
        "battle-region": ("battle-region-atari-guide.html", "バトルリージョン 当たりカードランキング・封入率完全ガイド"),
        "incandescent-arcana": ("incandescent-arcana-atari-guide.html", "白熱のアルカナ 当たりカードランキング・封入率完全ガイド"),
        "violet-ex": ("violet-ex-atari-guide.html", "バイオレットex 当たりカードランキング・封入率完全ガイド"),
        "black-bolt-dx": ("dx-vs-normal-guide.html", "拡張パックDXと通常版はどちらを買うべきか"),
        "white-flare-dx": ("dx-vs-normal-guide.html", "拡張パックDXと通常版はどちらを買うべきか"),
...
def _update_sitemap(
    ...
    static_pages = [
        ...
        ("/chusen-matome.html", "daily", "0.9", today),
        ("/box-hokan.html", "daily", "0.9", today),
        ...
        ("/30th-celebration-review.html", "monthly", "0.9", "2026-09-22"),
        ...
        ("/erika-sar-guide.html", "monthly", "0.8", "2026-09-03"),
        ...
        ("/mega-brave-atari-guide.html", "monthly", "0.8", "2026-09-03"),
        ("/chouden-breaker-atari-guide.html", "monthly", "0.8", "2026-09-01"),
        ("/clay-burst-atari-guide.html", "monthly", "0.8", "2026-09-01"),
        ("/ninja-spinner-atari-guide.html", "monthly", "0.8", "2026-09-01"),
        ("/munikis-zero-atari-guide.html", "monthly", "0.8", "2026-09-01"),
        ("/mega-sinfonia-atari-guide.html", "monthly", "0.8", "2026-09-01"),
        ("/black-bolt-atari-guide.html", "monthly", "0.8", "2026-09-01"),
        ("/rocket-dan-no-eiko-atari-guide.html", "monthly", "0.8", "2026-09-01"),
        ("/eevee-heroes-atari-guide.html", "monthly", "0.8", "2026-09-01"),
        ("/151-atari-guide.html", "monthly", "0.8", "2026-09-01"),
        ...
        ("/30th-celebration-atari-guide.html", "weekly", "0.9", "2026-09-16"),
        ...
        ("/opened-card-selling.html", "monthly", "0.8", "2026-08-12"),
        ...
        ("/battle-region-atari-guide.html", "monthly", "0.8", "2026-08-12"),
        ("/incandescent-arcana-atari-guide.html", "monthly", "0.8", "2026-08-12"),
        ...
        ("/vstar-universe-atari-guide.html", "monthly", "0.8", "2026-08-11"),
        ...
        ("/white-flare-atari-guide.html", "monthly", "0.8", "2026-09-01"),
        ("/terastal-fes-ex-atari-guide.html", "monthly", "0.8", "2026-09-03"),
        ("/shiny-treasure-ex-atari-guide.html", "monthly", "0.8", "2026-09-01"),
