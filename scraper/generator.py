...
BLOG_ARTICLES = [
    ...
    {"url": "30th-celebration-forecast.html", "title": "【追加抽選 8/31締切】30th CELEBRATION BOX3種の相場予想｜1年後・3年後・5年後", "desc": "ポケカ30周年「30th CELEBRATION」の抽選対象BOX3種(拡張パックBOX 定価¥7,200/FUTURISTIC BOX ¥27,500/プレミアムデッキセット エーフィ・ブラッキー ¥6,200)の相場を発売前予想。25周年商品の実績(25thコレクションが当サイト実データで定価×13.09、GOLDEN BOXが最大×15)を土台に、発売直後・1年後・3年後・5年後を3シナリオで算出。ポケモンセンターオンラインでは8月28日12:00〜8月31日16:59に追加抽選を受付中(対象は拡張パックBOX・プレミアムデッキセット・カードセット9種、FUTURISTIC BOXは対象外)。発売は9月16日世界同時。", "date": "2026-08-11"},
