...
MASTER_PRODUCTS: list[MasterProduct] = [
    ...
    MasterProduct("mega", 'MEGA 拡張パック「メガブレイブ」', 5800,
                  ["メガブレイブ", "MEGABRAVE"]),
    MasterProduct("mega", 'MEGA ハイクラスパック「MEGAドリームex」', 5800,
    ...
    MasterProduct("sv", 'SV 拡張パック「超電ブレイカー」', 5400,
                  ["超電ブレイカー", "超電"]),
    MasterProduct("sv", 'SV 拡張パックDX「ブラックボルト」', 0,
                  ["ブラックボルト", "BLACKVOLT", "拡張パックDXブラック"]),
    MasterProduct("sv", 'SV 拡張パックDX「ホワイトフレア」', 0,
    ...
    MasterProduct("sv", 'SV 強化拡張パック「熱風のアリーナ」', 5400,
                  ["熱風のアリーナ", "熱風", "アリーナ"]),
    MasterProduct("sv", 'SV ハイクラスパック テラスタルフェスex', 5400,
                  ["テラスタルフェス", "テラスタル"]),
    ...
    MasterProduct("sv", 'SV 拡張パック「クリムゾンヘイズ」', 5400,
                  ["クリムゾンヘイズ", "クリムゾン"]),
    MasterProduct("sv", 'SV ハイクラスパック「シャイニートレジャーex」', 5400,
                  ["シャイニートレジャー", "シャイニー"]),
