...
<li><strong>状態の影響が大きい</strong> — PSA10取得率71.7%が示すとおり、このカードは状態のばらつきが大きい部類です。センタリング・角のスレ・表面のキズは査定に直結します。</li>
...
<li><strong>鑑定済みを選ぶ</strong> — 200万円超の取引で素体を個人間でやり取りするリスクは大きく、PSA10なら真贋と状態が担保されます。</li>
...
<li><strong>鑑定は比較的通りやすい</strong> — PSA10取得率89.6%で、素体買取70万に対しPSA10相場は約109万(約1.56倍)。鑑定料・期間を踏まえたうえで検討する価値はあります。</li>
...
<p><a href="op-11-atari-guide.html">神速の拳(OP-11)</a>のコミパラ最高額は14万円ですが、この弾には<strong>3周年スペシャル(金)のルフィが買取140万円</strong>で存在します。コミパラではないため本ランキングには出てきませんが、BOXの開封需要はこちらが牽引しています。<strong>コミパラだけを見ると弾の実力を見誤る</strong>典型例です。</p>
