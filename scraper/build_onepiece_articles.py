...
HOWTO_ARTICLES = [
 ...
 'body': '<p>ワンピースカードのBOXは、弾によって買取価格が数千円から数万円まで開きます。手元に置いたまま値上がりを待つなら、<strong>保管の状態がそのまま手取りに響きます</strong>。</p>\n'
         ...
         '</ul>\n'
         '<div class="callout" '
         'style="display:flex;gap:16px;align-items:flex-start;flex-wrap:wrap"><a '
         'href="{{AZ:B003CFGNRY}}" rel="nofollow sponsored" target="_blank" style="flex:0 0 '
         'auto"><img src="https://m.media-amazon.com/images/I/51e77jcSnlL._AC_SL400_.jpg" '
         'alt="TRUSCO スケルコン スケルトンコンテナ ロックフタ付 50L" width="140" height="140" loading="lazy" '
         'decoding="async" '
         'style="width:140px;height:auto;border-radius:8px;background:#fff"></a><div style="flex:1 '
         '1 260px;min-width:240px"><strong><a href="{{AZ:B003CFGNRY}}" rel="nofollow sponsored" '
         'target="_blank">TRUSCO スケルコン スケルトンコンテナ ロックフタ付 '
         '50L</a></strong><br>ロックできるフタが付いた折りたたみコンテナです。ポケモンカードの通常BOXで実際に詰めたところ<strong>55〜58箱</strong>入りました(ハイクラスパックなら90〜94箱)。ワンピースカードのBOXは寸法が違うため箱数は変わりますが、まとめて床から上げる用途は同じです。半透明で中身が見え、使わないときは畳めます。積み重ねられます。</div></div><ul>\n'
