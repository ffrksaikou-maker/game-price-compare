...
<div class="ad">
  <a href="https://px.a8.net/svt/ejp?a8mat=4BCFNO+BB8IK2+5W1M+BXB8X" rel="nofollow"><img src="https://www29.a8.net/svt/bgt?aid=260920644684&wid=001&eno=01&mid=s00000027481002003000&mc=1" alt="ふるいち トレカ宅配買取" border="0" width="300" height="250" loading="lazy" decoding="async" style="max-width:100%;height:auto"></a><img src="https://www13.a8.net/0.gif?a8mat=4BCFNO+BB8IK2+5W1M+BXB8X" alt="" border="0" width="1" height="1">
</div>"""
...
.header .site-title{font-size:18px;font-weight:700;background:linear-gradient(135deg,#ff6b6b,#e53935);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
...
HOWTO_ARTICLES = [
 ...
 'date': '2026-09-11',
 'date_jp': '2026年9月11日',
 'title': 'ワンピカードBOXの保管方法｜買取価格を落とさない置き方と対策',
 'h1': 'ワンピカードBOXの保管方法｜買取価格を落とさない置き方',
 'meta_desc': 'ワンピースカードのBOXを買取価格を落とさずに保管する方法をまとめました。シュリンクを剥がすと買取が平均12.3%下がるという実測値、2026年8月の記録的大雨をふまえた置き場所のリスク、ワンピBOX専用のローダーや防湿庫など、実際に使える対策を整理します。',
 'og_title': 'ワンピカードBOXの保管方法｜買取価格を落とさない置き方',
 'og_desc': 'シュリンクを剥がすと買取は平均-12.3%。大雨をふまえた置き場所の注意と、ワンピBOX専用ローダーまで。',
 'meta_line': 'BOXの状態と買取価格の関係、置き場所のリスク、使える保管用品',
 'hero_label': 'シュリンクを剥がしたときの買取下落率(38商品平均)',
 'hero_big': '-12.3%',
 'hero_sub': '金額では平均約2,155円。最大で-9,000円の差が付く',
 'disclaimer': 'シュリンク付き・なしの下落率は<strong>買取コレクトが2026年9月7日に公開した価格表</strong>のポケモンカード38商品を集計したもので、当サイトが比較表で使っている買取実データとは別の集計です。価格は日々変動します。当サイトの比較表に掲載している買取価格は<strong>シュリンク付き</strong>のものです。大雨に関する数値は日本気象協会および国土交通省の公表値によります。本記事にはAmazonアソシエイトのリンクを含みます。',
 'related': '<li><a href="/onepiece">ワンピBOX買取価格比較トップ</a> — 全弾のBOX買取価格を最大10店舗で横断比較(毎日更新)</li>\n'
            '<li><a href="kougaku-ranking.html">高額BOXランキング・絶版まとめ</a> — 保管する価値が高い弾はどれか</li>\n'
            '<li><a href="toushi.html">ワンピカードBOX投資の始め方</a> — 買って寝かせるときの考え方</li>\n'
            '<li><a href="https://pokeca-box-hikaku.com/box-hokan.html">ポケカBOXの保管方法</a> — '
            'シュリンク有無の下落率を商品別の表で掲載</li>\n',
 'body': '<p>ワンピースカードのBOXは、弾によって買取価格が数千円から数万円まで開きます。手元に置いたまま値上がりを待つなら、<strong>保管の状態がそのまま手取りに響きます</strong>。</p>\n'
         '<p>この記事では、シュリンクの有無で買取がどれだけ変わるかという実測値と、2026年8月に各地で起きた記録的な大雨をふまえた<strong>置き場所のリスク</strong>、そして実際に使える保管用品を整理します。</p>\n'
         '\n'
         '<h2>シュリンクは剥がした時点で価値が落ちる</h2>\n'
         '<p>未開封BOXの買取は<strong>シュリンク付き</strong>が前提です。剥がすといくら落ちるのかを、シュリンク付きとなしの両方を公開している買取店の価格表から集計しました。ポケモンカードの38商品での実測ですが、下がり方の傾向はワンピースカードでも変わりません。</p>\n'
         '<ul>\n'
         '<li>下落率の平均は<strong>12.3%</strong>(中央値12.7%)、金額では平均約2,155円</li>\n'
         '<li>高額なBOXほど失う金額が大きく、最大で<strong>9,000円</strong>の差</li>\n'
         '<li>率で見ると弾ごとの幅が広く、<strong>-2.7%から-24.4%</strong>まで開く</li>\n'
         '</ul>\n'
         '<p>集計の内訳は<a '
         'href="https://pokeca-box-hikaku.com/box-hokan.html">ポケカBOXの保管方法(シュリンクを剥がすと買取はいくら落ちるか)</a>に商品別の表で載せています。</p>\n'
         '<div class="callout"><strong>当サイトの掲載価格について。</strong> '
         'ワンピBOX買取価格比較に載せているのは<strong>シュリンク付きの買取価格</strong>です。シュリンクを剥がした状態で売る場合は、表の金額から1割前後を差し引いて考えてください。</div>\n'
         '\n'
         ...
         '<p>目安は<strong>湿度40〜50%</strong>。押し入れやクローゼットの<strong>下段は湿気がたまりやすい</strong>ので、上段に移すだけでも変わります。</p>\n'
         '<ul>\n'
         '<li><a href="{{AZ:B0C6Z6FN9B}}" rel="nofollow sponsored" target="_blank">ハクバ トレカ用防湿庫 '
         'E-ドライボックス KED-P60ETC</a> — トレカ向けに湿度を自動管理するタイプ。保有額が増えてきたら選択肢に入ります</li>\n'
         ...
         '<p>対策は単純で、費用もほとんどかかりません。</p>\n'
         '<ul>\n'
         '<li><strong>床に直置きしない</strong> — 棚やカラーボックスに上げるだけで、床上浸水の初期は避けられます</li>\n'
         '<li><strong>1階より上階に置く</strong> — 高額な弾ほど上へ</li>\n'
         '<li><strong>ふた付きの箱に入れる</strong> — 雨漏りや結露のような「上から」にも効きます</li>\n'
         '</ul>\n'
         '<div class="callout"><strong><a href="{{AZ:B003CFGNRY}}" rel="nofollow sponsored" '
         'target="_blank">TRUSCO スケルコン スケルトンコンテナ ロックフタ付 '
         '50L</a></strong><br>ロックできるフタが付いた折りたたみコンテナです。ポケモンカードの通常BOXで実際に詰めたところ<strong>55〜58箱</strong>入りました(ハイクラスパックなら90〜94箱)。ワンピースカードのBOXは寸法が違うため箱数は変わりますが、まとめて床から上げる用途は同じです。半透明で中身が見え、使わないときは畳めます。積み重ねられます。<div '
         'style="display:flex;gap:10px;margin-top:12px;flex-wrap:wrap"><img '
         'src="/images/hokan/oricon-pokeca-box-1.jpg" alt="オリコンにポケモンカードのBOXを詰めた状態を上から見たところ" '
         'width="750" height="1000" loading="lazy" decoding="async" '
         'style="width:min(47%,215px);height:auto;border-radius:8px"><img '
         'src="/images/hokan/oricon-pokeca-box-2.jpg" alt="オリコンに並べたポケモンカードのBOXを斜めから見たところ" '
         'width="750" height="1000" loading="lazy" decoding="async" '
         'style="width:min(47%,215px);height:auto;border-radius:8px"></div><div '
         'style="font-size:11.5px;color:#6b7280;margin-top:6px">実際に詰めたところ。2列でちょうど収まります</div></div><ul>\n'
         '<li><a href="{{AZ:B0BSGGF215}}" rel="nofollow sponsored" target="_blank">河島製作所 '
         'フルプロテクトパックケースP(2個入り)</a> — パックやカードをまとめて隔離しておく用途に</li>\n'
         '</ul>\n'
         '\n'
         '<h2>潰れ・日焼けから守る</h2>\n'
         '<p>BOXは積み重ねると<strong>下のものから潰れます</strong>。角が潰れた箱は、未開封でも査定が下がります。直射日光の当たる場所では外箱の印刷が退色し、シュリンクが縮んで白化することもあります。</p>\n'
         '<p>ワンピースカードのBOXはポケモンカードとサイズが違うため、<strong>ワンピ用のローダーを選ぶ</strong>必要があります。</p>\n'
         '<ul>\n'
         '<li><a href="{{AZ:B0CH7V948G}}" rel="nofollow sponsored" target="_blank">Boxx Guardian '
         'ワンピースカードゲームBOX用 ハードローダー(UVカット)</a> — BOXを1箱ずつ収めるタイプ。積み重ねても潰れず、日焼けも抑えられます</li>\n'
         '<li><a href="{{AZ:B0H51521BL}}" rel="nofollow sponsored" target="_blank">ワンピカード BOXケース '
         'OP-05以降用(30枚)</a> — まとめて数を揃えたいとき向けのセミハードタイプ</li>\n'
         ...
         '<ol>\n'
         '<li><strong>シュリンクの有無</strong> — ここが最大。平均で1割強</li>\n'
         ...
         '</ol>\n'
         '<p>保管の良し悪しは、同じ弾でも数千円の差になります。売るときの<strong>店舗ごとの価格差</strong>と合わせれば、手取りはさらに変わります。</p>\n',
 'faq': [{'q': 'シュリンクを剥がすと買取はどれくらい下がりますか？',
          'a': 'シュリンク付きとなしの両方を公開している買取店の価格表(2026年9月7日時点・ポケモンカード38商品)で集計すると、平均で<strong>12.3%</strong>、金額にして平均約2,155円下がります。弾による差が大きく、下落率は-2.7%から-24.4%まで開きます。高額なBOXほど失う金額が大きくなります。'},
         {'q': 'ワンピBOXにポケカ用のBOXローダーは使えますか？',
          'a': 'サイズが違うため、<strong>ワンピース用として売られているものを選んでください</strong>。ワンピース用でも、OP-05以降のBOXとそれ以前、プレミアムブースターなどで寸法が異なる商品があるため、対応する弾の表記を確認してから購入するのが確実です。'},
         {'q': 'BOXはどこに置くのがいいですか？',
          'a': '湿度が40〜50%で安定し、直射日光が当たらず、<strong>床に直置きしない</strong>場所です。2026年8月には千葉・石川・富山・福井で観測1位クラスの大雨が続き、各地で浸水が起きました。浸水は床から来るため、棚に上げる・上階に置くだけでもリスクが下がります。'},
         {'q': '水に濡れたBOXは売れますか？',
          'a': '外箱が水を吸った時点で、買取対象外になるか大幅な減額になります。シュリンクが無事でも、箱が波打っていたり底面にシミがあれば同じ扱いです。乾かしても元の評価には戻らないため、濡らさないことが唯一の対策です。'}]},
    {'slug': 'chusen-matome',
     'nav_label': '抽選販売まとめ',
     ...
     'meta_desc': 'ONE '
                  'PIECEカードゲームのBOX抽選販売を、当サイトが最大10店舗から毎日自動収集している買取実データと突き合わせて整理します。直近{{CH_N}}弾のうち{{CH_OVER_N}}弾が定価を上回っており、最も差が大きい{{CH_TOP_NAME}}は定価{{CH_TOP_RETAIL}}に対し買取{{CH_TOP_PRICE}}({{CH_TOP_GAIN}}差)。抽選をやっている店舗と、応募する価値の判断材料をまとめました。',
     ...
     'hero_sub': '定価{{CH_TOP_RETAIL}}に対して現在の最高買取は{{CH_TOP_PRICE}}({{CH_TOP_MULT}})。直近{{CH_DONE_N}}弾のうち{{CH_OVER_N}}弾が定価を上回っています。数値は当サイトが最大10店舗から毎日自動収集した実データです。',
     'disclaimer': '本記事の買取価格は当サイトが最大10店舗から自動取得した実データで、表示は取得時点のスナップショットです。定価はメーカー希望小売価格(税込)で、実売価格とは異なります。抽選の受付状況・応募条件は各店舗が随時変更するため、応募の前に必ず各店舗の公式ページで最新情報をご確認ください。当サイトは抽選の当選を保証するものではありません。買取価格は需給で日々変動し、当選から売却までの間に下落することもあります。売買の判断はご自身の責任で行ってください。当サイトはAmazonのアソシエイトとして、適格販売により収入を得ています。',
     'related': '<li><a href="/onepiece">ワンピBOX買取価格比較トップ</a> — 全弾のBOX買取価格を最大10店舗で横断比較(毎日更新)</li>\n'
     ...
     'body': '<p>ONE PIECEカードゲームの人気弾は、発売時に<strong>抽選販売</strong>になることがあります。抽選は定価で買える機会ですが、「応募する価値があるのか」を判断するには<strong>定価と実際の相場の差</strong>を知る必要があります。</p>\n'
             ...
             '</ul>\n'
             '<div class="callout"><strong>応募先を選ぶ基準:</strong> 抽選は定価で買える機会ですが、<strong>商品によって定価との差はまるで違います</strong>。差が小さい商品に手間をかけるより、差が大きい商品に応募を集中させるほうが効率的です。</div>\n'
             '\n'
             '<h2>抽選に外れたときの選択肢</h2>\n'
             '<ul>\n'
    ...
    {'slug': 'eb-05-forecast',
     ...
     'meta_desc': '2026年10月31日発売のワンピカード エクストラブースター第5弾「ONE PIECE Heroines Edition '
                  'vol.2」(EB-05)のBOX相場を、当サイトが最大10店舗から自動収集したEB-01〜EB-04の実データで予想します。この弾から定価が5,280円→5,760円に変わるため定価比の基準が動く点、前作ヒロインズ(EB-03)が発売10か月で定価比4.3倍を保っている一方でEB-04が直近51日で-17.2%と下げている点を踏まえ、3シナリオで整理します。',
     ...
     'disclaimer': '本記事は2026年9月2日時点で公表されている情報と、当サイトが最大10店舗から自動取得したエクストラブースター各弾のBOX買取実データに基づく<strong>発売前の予想記事</strong>です。3シナリオのBOX相場は筆者の分析であり、公式発表や確定情報ではありません。EB-05の収録内容は本記事作成時点で全種が公開されていません。収録カードの相場予想を掲載している各メディアの数値は<strong>非公式の予想値</strong>で、ソースにより幅があります。実際の相場は需給・再販・大会環境など多くの要因で大きく変動し、購入価格を下回ることもあります。投資助言を目的とするものではありません。売買の判断はご自身の責任で行ってください。実際のBOX買取価格は発売後に当サイトの実データで随時更新します。',
     'related': '<li><a href="/onepiece">ワンピBOX買取価格比較トップ</a> — 全弾のBOX買取価格を最大10店舗で横断比較(毎日更新)</li>\n'
     ...
     'body': '<p>2026年10月31日(土)、ONE PIECEカードゲームのエクストラブースター第5弾 <strong>「ONE PIECE Heroines Edition vol.2」(EB-05)</strong> '
             'が発売されます。女性キャラクターだけを収録するヒロインズエディションの第2弾です。本記事では、当サイトが最大10店舗から毎日自動収集している<strong>エクストラブースター4弾ぶんの実データ</strong>から、EB-05のBOX相場がどのあたりに着地しそうかを整理します。</p>\n'
             '\n'
             ...
             '<p>まず土台になるのが、既存のエクストラブースターが今どうなっているかです。以下はすべて当サイトが最大10店舗から自動取得した実データです。</p>\n'
             '<table class="price-table">\n'
             ...
             '<p>10月31日の発売後は、当サイトが最大10店舗の買取価格を毎日自動取得し、<a href="/onepiece">比較トップ</a>で更新します。予想がどこまで当たったかは、発売後に本記事へ追記する形で答え合わせをします。</p>\n',
     'faq': [{'q': 'EB-05「ヒロインズエディション vol.2」の発売日と定価は？', 'a': '2026年10月31日(土)発売で、定価は1パック240円(税込)、1BOX(24パック)5,760円(税込)です。エクストラブースターとしては初めて5,760円になる弾で、EB-01〜EB-04はいずれも5,280円でした。'},
             ...
             {'q': '前作のヒロインズエディション(EB-03)は今いくらですか？', 'a': '当サイトが最大10店舗から取得した実データで最高22,800円(定価5,280円の約4.3倍)です。直近51日でも-0.9%とほぼ動いておらず、発売から10か月が経って相場が安定した状態にあります。'},
             ...
             {'q': 'PRECIOUS BOXと通常のBOXは同じものですか？', 'a': '別商品です。ONE PIECE HEROINES PRECIOUS BOXはBOXにスリーブとドン!!カードが付いたセット商品で、通常のEB-05 BOXとは買取価格も別建てになります。売買のときは商品名を必ず確認してください。'}]},
    {
        ...
        "crumb": "新弾発売スケジュール",
        "date": "2026-08-27",
        "title": "ワンピースカード 新弾発売スケジュール｜EB-05・OP-18の発売日と定価改定を整理",
        "h1": "ワンピースカード 新弾発売スケジュール｜EB-05・OP-18の発売日とBOX定価",
        "meta_desc": "ワンピースカードゲームの新弾発売スケジュールをまとめて確認。EB-05「ONE PIECE Heroines Edition vol.2」(2026年10月31日・BOX5,760円)とOP-18(2026年11月予定)の最新情報、OP-17から実施された1パック240円への定価改定、発売前後で買取相場がどう動くかを実データ視点で解説します。",
        "og_title": "ワンピースカード 新弾発売スケジュール｜EB-05・OP-18",
        "og_desc": "EB-05は2026年10月31日発売・BOX定価5,760円。OP-18は2026年11月予定。OP-17から1パック240円へ改定された定価の変化と、発売前後の買取相場の動きを整理。",
        "meta_line": "新弾の発売日・BOX定価・相場への影響",
        "hero_label": "新弾発売スケジュール",
        "hero_big": "次はEB-05(10/31)とOP-18(11月)",
        "hero_sub": "ワンピースカードゲームの発売予定を弾ごとに整理。2026年はOP-17から1パック240円へ定価が改定され、BOX定価も5,280円→5,760円に変わりました。発売日・定価・相場の動きをまとめて確認できます。",
        "body": """<p>ワンピースカードゲームは年間を通して新弾が発売され、<strong>発売の前後で未開封BOXの買取相場が大きく動きます</strong>。「次の弾はいつ出るのか」「手元のBOXは新弾前に売るべきか」を判断するには、まず発売スケジュールの把握が欠かせません。本記事では<strong>これから発売される弾の日程・BOX定価</strong>と、<strong>2026年に実施された定価改定</strong>を整理します。各弾の実際の買取価格は <a href="/onepiece">ワンピBOX買取価格比較トップ</a> で毎日更新しているので、あわせてご確認ください。</p>

<h2>これから発売される弾</h2>
<p>2026年8月27日時点で判明している発売予定は次の通りです。<strong>OP-18は発売日・価格ともに未発表</strong>のため、判明している範囲のみ記載しています。</p>
<table class="tbl">
<thead><tr><th>発売日</th><th>商品名</th><th>弾番号</th><th>BOX定価(税込)</th></tr></thead>
<tbody>
<tr><td>2026年10月31日</td><td>エクストラブースター<br>ONE PIECE Heroines Edition vol.2</td><td>EB-05</td><td>5,760円</td></tr>
<tr><td>2026年11月(日付未発表)</td><td>ブースターパック 第18弾</td><td>OP-18</td><td>未発表</td></tr>
</tbody>
</table>

<h3>EB-05「ONE PIECE Heroines Edition vol.2」(2026年10月31日)</h3>
<p>エクストラブースター第5弾で、<strong>女性キャラクターを集めた「Heroines Edition」の第2弾</strong>にあたります。1作目の <a href="box/eb-03.html">EB-03「ONE PIECE Heroines Edition」</a> は女性人気の高いキャラを中心に構成され、発売後も安定した需要がありました。今回はその続編という位置づけです。</p>
<ul>
<li><strong>発売日</strong>: 2026年10月31日(土)</li>
<li><strong>1パック</strong>: 240円(税込)・カード6枚入り</li>
<li><strong>1BOX</strong>: 24パック入り・<strong>5,760円(税込)</strong></li>
</ul>
<p>同日には特別仕様の「ONE PIECE HEROINES PRECIOUS BOX」も発売予定とされていますが、価格・内容の詳細は発表を待つ状況です。</p>

<h3>OP-18(2026年11月予定)</h3>
<p>通常ブースターの第18弾です。テーマは<strong>ウォーターセブン</strong>とされ、エニエス・ロビー編に連なる人気エピソードが題材になります。シークレットレアにはイラストレーター天野喜孝氏の描き下ろしパラレルが存在するとされ、注目度の高い弾になりそうです。</p>
<p>ただし<strong>正式な発売日・BOX定価・収録内容はいずれも未発表</strong>です。直前の <a href="box/op-17.html">OP-17「世界最強の戦士」</a> がBOX定価5,760円だったことから同水準が見込まれますが、確定情報が出るまでは断定できません。発表があり次第、当サイトの比較表にも追加します。</p>

<h2>2026年に定価が上がりました</h2>
<p>スケジュールを見るうえで見落とせないのが、<strong>2026年に実施されたパック単価の改定</strong>です。<a href="box/op-17.html">OP-17「世界最強の戦士」</a>(2026年8月22日発売)から、<strong>1パック220円→240円</strong>に変更されました。</p>
<table class="tbl">
<thead><tr><th>区分</th><th>1パック</th><th>BOX構成</th><th>BOX定価</th></tr></thead>
<tbody>
<tr><td>OP-16以前 / EB-04以前</td><td>220円</td><td>24パック</td><td>5,280円</td></tr>
<tr><td>OP-17以降 / EB-05</td><td><strong>240円</strong></td><td>24パック</td><td><strong>5,760円</strong></td></tr>
</tbody>
</table>
<p>BOX1個あたり<strong>480円の値上げ</strong>です。買取価格を「定価の何倍か」で評価する場合、旧弾と新弾では基準となる定価が違う点に注意してください。たとえば同じ買取10,000円でも、5,280円の弾なら約1.89倍、5,760円の弾なら約1.74倍と、実質的な評価は変わります。当サイトの比較表では各弾の定価を弾ごとに保持しているため、<strong>定価改定をまたいでも正しい倍率</strong>で比較できます。</p>

<h2>新弾の発売は買取相場にどう影響するか</h2>
<p>新弾の発売は、その弾自身だけでなく<strong>既存弾の相場にも影響</strong>します。当サイトが毎日収集している買取データからは、おおむね次のような傾向が読み取れます。</p>
<h3>発売直後は品薄で動きやすい</h3>
<p>発売直後は流通量が限られ、注目度も最も高い時期です。<strong>需要が供給を上回ると買取価格が上がりやすく</strong>、逆に初動の評価が伸びないと早い段階で落ち着くこともあります。値動きの実際は <a href="weekly.html">週間値動きランキング</a> で日々確認できます。</p>
<h3>供給が安定すると水準が定まる</h3>
<p>再販や追加出荷で在庫が行き渡ると、相場は一定の水準に落ち着く傾向があります。この局面では店舗間の価格差も縮まりやすくなります。</p>
<h3>旧弾は「入れ替わり」で動く</h3>
<p>新弾に人気カードが再録されたり、環境が変わったりすると、旧弾の需要が動くことがあります。特に<strong>同じテーマの続編が出る弾</strong>は関連して注目されやすく、EB-05の発売はシリーズ第1弾の <a href="box/eb-03.html">EB-03</a> にも目が向くきっかけになり得ます。</p>
<p>弾ごとの値動きのパターンについては <a href="box-price-pattern.html">ワンピBOX価格の動き方</a> でより詳しく整理しています。売却タイミングの判断材料としてあわせてご覧ください。</p>

<h2>スケジュールを踏まえた売買の考え方</h2>
<p>発売日が分かっていると、<strong>売るタイミングの選択肢</strong>が広がります。</p>
<ul>
<li><strong>売却を考えているBOXがある</strong>: 新弾発売の前後は相場が動きやすい時期です。急がないなら値動きを見てから判断するのが有利になり得ます。</li>
<li><strong>新弾を買う予定がある</strong>: BOX定価が5,760円に上がっているため、購入コストの前提が旧弾と異なります。</li>
<li><strong>複数店を比較する</strong>: どのタイミングでも、店舗ごとの価格差は残ります。売る直前に <a href="/onepiece">最大10店舗の比較</a> で最新値を確認してください。</li>
</ul>
<p>なお本記事の発売日・価格はメーカー発表および各販売店の告知に基づく2026年8月27日時点の情報です。<strong>発売日や仕様は変更される場合がある</strong>ため、購入・売却の判断前には最新の公式情報をご確認ください。買取価格は当サイトの実データで毎日更新しています。</p>""",
        "faq": [
            {"q": "EB-05「ONE PIECE Heroines Edition vol.2」の発売日はいつですか?",
             "a": "2026年10月31日(土)発売予定です。1パック240円(税込・カード6枚入り)、1BOX24パック入りでBOX定価は5,760円(税込)となっています。"},
            {"q": "OP-18の発売日と価格は決まっていますか?",
             "a": "2026年11月発売予定という情報のみで、具体的な日付・BOX定価・収録内容はいずれも未発表です(2026年8月27日時点)。テーマはウォーターセブンとされ、天野喜孝氏描き下ろしのパラレルが存在するとされています。発表があり次第、当サイトの比較表にも追加します。"},
            {"q": "BOXの定価が5,280円から5,760円に変わったのはなぜですか?",
             "a": "2026年8月22日発売のOP-17「世界最強の戦士」から、1パックの価格が220円から240円に改定されたためです。BOXの構成は24パック入りのまま変わらないため、24パック×240円で定価が5,760円になっています。EB-05も同じく240円×24パックです。"},
            {"q": "新弾が出ると既存BOXの買取価格は下がりますか?",
             "a": "必ず下がるとは限りません。新弾の内容や再録カード、環境の変化によって既存弾の需要が動くため、上がる弾もあれば下がる弾もあります。当サイトの週間値動きランキングで直近7日間の変動を確認するのが確実です。"},
    ...
    },
    {
        ...
        "crumb": "ワンピBOX買取比較ガイド",
        "title": "ワンピBOX買取比較ガイド｜最大10店舗の実データで高く売るコツと店舗の選び方",
        "h1": "ワンピBOX買取比較ガイド｜未開封BOXを最大10店舗の実データで高く売るコツと店舗の選び方",
        "meta_desc": "ワンピースカードの未開封BOXを高く売るための店舗比較・売り方ガイド。シュリンクや外箱状態などの査定ポイント、最大10店舗を毎日自動比較する当サイトの使い方、高く売る5つのコツ、今買取が高い傾向のBOXまで実データ視点で解説。",
        "og_title": "ワンピBOX買取比較ガイド｜最大10店舗の実データで高く売るコツ",
        "og_desc": "ワンピースカードの未開封BOXを高く売る店舗比較・売り方ガイド。シュリンク・外箱の査定ポイント、最大10店舗比較の使い方、高く売る5つのコツを実データ視点で解説。",
        "meta_line": "ワンピBOX買取の基礎知識・店舗比較・高く売るコツ",
        "hero_label": "ワンピBOX買取比較ガイド",
        "hero_big": "最大10店舗を毎日自動比較",
        "hero_sub": "シュリンク維持・複数店比較・売却タイミングの見極めで、ワンピースカードの未開封BOXをできるだけ高く売るための実践ガイド。相場は当サイトの実データで毎日チェックできます。",
        "body": """<p>ワンピースカードゲームの未開封BOXは、弾(タイトル)によって買取価格が大きく異なり、<strong>同じ弾でも店舗ごとに数百円〜数千円の差</strong>が出ることが珍しくありません。せっかく売るなら、少しでも高い店で・良いタイミングで手放したいところです。本記事では、<strong>ワンピBOXをできるだけ高く売るための店舗比較・売り方のコツ</strong>を、当サイトが最大10店舗から毎日自動収集している買取価格データの視点で整理します。「どこで売れば一番高いのか」「今売るべきか」を判断する材料としてご活用ください。最新の店舗別買取価格は <a href="/onepiece">ワンピBOX買取価格比較トップ</a> で毎日更新しています。</p>
...
<h2>当サイトの強み｜最大10店舗を毎日自動比較</h2>
<p>当サイト「ワンピ買取チェッカー」は、ワンピースカードのBOX買取に対応した<strong>最大10店舗</strong>の買取価格を毎日自動で収集し、弾ごとに横断比較できるようにしています。1店舗ずつ公式サイトを見て回る必要がなく、<strong>「今どの店が一番高いか」を一目で確認</strong>できるのが最大の強みです。</p>
<ul>
...
<p>相場は日々変動するため、売る直前に最新の比較データを確認するのが失敗しないコツです。具体的な金額は断定せず、<strong>当サイトの最大10店舗比較の実データで最新値を確認</strong>してから判断してください。</p>
...
<p>ワンピースカードの中でも、特に高額で取引されやすい傾向のある弾を紹介します。金額は需給で日々変動するため、必ず<strong>当サイトの最大10店舗比較の実データで最新値を確認</strong>してください(下記は各弾の看板カードや傾向であり、BOX買取価格の断定ではありません)。</p>
<ul>
...
<p>当サイトは各店のワンピBOX買取ページへ直接リンクしているため、<strong>比較 → 最高値の店へ移動 → 条件確認</strong>という流れをスムーズに進められます。</p>""",
        "faq": [
            {"q": "ワンピBOXはどこで売るのが一番高いですか？",
             "a": "弾やタイミングによって最高値の店舗は変わります。当サイトはワンピBOX買取に対応した最大10店舗の価格を毎日自動比較しているため、<a href=\"/onepiece\">比較トップ</a>で売りたい弾の最新価格を並べて、その時点で最も高い店を選ぶのが確実です。"},
    ...
    },
    {
        ...
        "meta_desc": "ワンピースカードの未開封BOX投資の始め方を初心者向けに解説。なぜBOXが値上がりするのかの基礎、値上がりしやすいBOXの特徴、予算別の始め方、シュリンク・湿度・日光を避ける保管方法、再販や相場変動などのリスクと注意点、今狙い目の高額弾までを最大10店舗比較の実データ視点で整理します。",
        "og_title": "ワンピカードBOX投資の始め方｜値上がりBOXの特徴・予算別・保管・リスク",
        "og_desc": "ワンピBOX投資の始め方を初心者向けに解説。値上がりしやすいBOXの特徴、予算別の始め方、シュリンク・湿度・日光を避ける保管、再販・相場変動のリスクを最大10店舗比較の実データ視点で整理。",
        "meta_line": "ワンピBOX投資の基礎・値上がりBOXの特徴・予算別の始め方・保管・リスク",
        "hero_label": "ワンピカードBOX投資の始め方",
        "hero_big": "基礎・銘柄選び・保管・リスクを網羅",
        "hero_sub": "なぜBOXが値上がりするのかの基礎から、値上がりしやすいBOXの特徴・予算別の始め方・正しい保管・再販や相場変動のリスクまでを初心者向けに整理。相場は断定せず、当サイトの最大10店舗比較の実データで最新値を確認しながら判断できます。",
        "body": """<p>ワンピースカードゲームの未開封BOXは、発売から時間が経つほど市場の在庫が減り、人気弾では<strong>定価を大きく上回る価格で取引される</strong>ことがあります。この「未開封BOXを値上がり目的で保有する」という考え方が、いわゆる<strong>ワンピBOX投資</strong>です。本記事では、これからワンピBOX投資を始めたい方向けに、<strong>なぜBOXが値上がりするのかの基礎・値上がりしやすいBOXの特徴・予算別の始め方・正しい保管方法・リスクと注意点</strong>を、当サイトが最大10店舗から毎日自動収集している買取価格データの視点で整理します。相場は日々変動するため、金額は断定せず、必ず <a href="/onepiece">ワンピBOX買取価格比較トップ</a> の実データで最新値を確認しながら読み進めてください。すでに売却を考えている方は、姉妹記事の <a href="kaitori-hikaku.html">ワンピBOX買取比較ガイド</a> も参考になります。</p>
...
<p>資金に余裕がある場合、カートン(BOX複数入りの輸送箱)単位での保有や、超高額看板を持つ人気弾のBOXも選択肢になります。ただし高額になるほど<strong>1点あたりの下落リスク・保管リスク</strong>も大きくなるため、分散と保管には特に注意が必要です。購入前・売却前には必ず最大10店舗の実データで最新の相場を確認しましょう。</p>
...
<h2>今、狙い目・高額な弾の例</h2>
<p>ワンピースカードの中でも、超高額の看板カードを擁し需要が高い傾向のある弾を紹介します。金額は需給で日々変動するため、必ず<strong>当サイトの最大10店舗比較の実データで最新値を確認</strong>してください(下記は各弾の看板や傾向であり、BOX価格の断定ではありません)。</p>
<ul>
<li><strong><a href="op-13-atari-guide.html">受け継がれる意志(OP-13)</a></strong> — ルフィ・エース・サボの「レッドスーパーパラレル(レッドコミパラ)」を擁する3周年記念弾。看板カードが超高額で、BOX需要も高い傾向です。</li>
<li><strong><a href="op-15-atari-guide.html">神の島の冒険(OP-15)</a></strong> — 空の神「エネル」のコミックパラレルが看板のスカイピア編テーマ弾。</li>
<li><strong><a href="op-16-atari-guide.html">決戦の刻(OP-16)</a></strong> — 海軍大将トリオのコミパラと日本版初のトレジャーレアが話題の最新弾。</li>
...
<p>投資したBOXを現金化するときも、<strong>複数店舗の比較</strong>が利益を最大化する基本です。同じBOXでも店舗ごとに買取価格が異なり、高額弾ほど差が大きくなります。当サイトはワンピBOX買取に対応した最大10店舗の価格を毎日自動比較しているため、<a href="/onepiece">比較トップ</a>で売りたい弾の最新価格を並べて最高値の店を選べます。売り方のコツは <a href="kaitori-hikaku.html">ワンピBOX買取比較ガイド</a> で詳しく解説しています。</p>""",
        "faq": [
            ...
            {"q": "どんなBOXが値上がりしやすいですか？",
             "a": "超高額の看板カード(コミックパラレルや周年スペシャル等)を擁する弾、周年記念・特別レアリティ導入の弾、再販が絞られている弾、発売から時間が経ち在庫が減ってきた弾などが、傾向として価格を維持・上昇しやすいとされます。ただし将来を保証するものではないため、実際の相場は当サイトの最大10店舗比較の実データで確認してください。"},
            {"q": "BOXはどう保管すればいいですか？",
    ...
    },
    {
        ...
        "meta_desc": "ワンピースカードの未開封BOX全弾を最高買取価格でランキング。1位は新時代の主役(OP-05)で最高買取{{TOP1_PRICE}}・定価の{{TOP1_MULT}}。定価比・発売年つきの一覧表と、公式の絶版アナウンスがない実態、2026年4月導入のブロックアイコン制度がBOX相場に与える影響を最大10店舗の実データで解説します。",
        "og_title": "ワンピカード 高額BOXランキング｜全弾の買取価格・定価比と絶版/ブロックアイコンの実態",
        "og_desc": "ワンピBOX全弾を最高買取価格でランキング。1位は新時代の主役(OP-05)で最高買取{{TOP1_PRICE}}・定価の{{TOP1_MULT}}。絶版の実態と2026年4月導入のブロックアイコン制度がBOX相場に与える影響を最大10店舗の実データで解説。",
        ...
        "disclaimer": "本記事のBOX買取価格は、当サイトが最大10店舗から自動取得した実データの記事更新時点のスナップショットです。相場は需給・再販・各店の在庫状況により日々変動するため、金額はあくまで目安であり特定の買取価格を保証するものではありません。また、ONE PIECEカードゲームには「絶版」「生産終了」の公式アナウンス制度がなく、本記事の入手性に関する記述は流通状況からの観測にとどまります。ブロックアイコン制度の適用区分は公式発表に基づきますが、エクストラブースター・プレミアムブースター等の個別の割り当てについては断定を避けています。最新・正確な情報は公式サイトをご確認ください。売買の判断はご自身の責任で行ってください。",
        "related": '<li><a href="/onepiece">ワンピBOX買取価格比較トップ</a> — 全弾のBOX買取価格を最大10店舗で横断比較(毎日更新)</li>\n'
        ...
        "body": """<p>ワンピースカードゲームの未開封BOXは、弾によって買取価格に<strong>数倍の開き</strong>があります。定価¥5,280前後の同じブースターパックでも、1万円台で落ち着くものから<strong>6万円を超える</strong>ものまで存在するのが実情です。本記事では、当サイトが最大10店舗から毎日自動収集している買取データをもとに、<strong>全{{BOX_COUNT}}弾を最高買取価格の高い順にランキング</strong>し、あわせて「ワンピカードに絶版はあるのか」「2026年4月に導入されたブロックアイコン制度はBOX相場にどう影響するのか」を整理します。なお、BOXではなく<strong>カード単体</strong>の最高額ランキングは <a href="comipara-ranking.html">歴代コミックパラレル相場ランキング全22弾</a> にまとめています。再販の実績・入手経路・相場への影響は <a href="restock-guide.html">再販・入荷ガイド</a> で扱っています。両者の順位は連動しないため、あわせて読むと弾ごとの実力を立体的に把握できます。</p>
...
<li><strong>売る直前の相場を確認する</strong> — 再販や新弾発売で相場は動きます。当サイトは毎日自動更新のため、売却直前に <a href="/onepiece">比較トップ</a> で最新の最高値を確認してから持ち込むのが確実です</li>
        ...
        "faq": [
            {"q": "ワンピースカードで一番高いBOXはどれですか？",
             "a": "当サイトが最大10店舗から自動収集した実データでは、ブースターパック「新時代の主役」(OP-05)が最高買取{{TOP1_PRICE}}で全弾トップです。定価¥5,280に対して{{TOP1_MULT}}の水準になります。次いでROMANCE DAWN(OP-01)が{{TOP2_PRICE}}、神速の拳(OP-11)が{{TOP3_PRICE}}と続きます。相場は日々変動するため、最新値は比較トップページでご確認ください。"},
            ...
            {"q": "高額BOXはどこで売るのが一番高いですか？",
             "a": "弾によって最高値の店舗は異なります。当サイトはワンピBOX買取に対応した最大10店舗の価格を毎日自動比較しているため、売りたい弾のページで最高値の店を確認するのが確実です。高額弾ほど店舗間の価格差が金額として大きくなるため、比較の効果も大きくなります。"},
    ...
    },
    {
        ...
        "meta_desc": "2026年8月22日発売のワンピカード新弾「世界最強の戦士」(OP-17)のBOX相場を、当サイト最大10店舗の過去弾実データから3シナリオ(弱気¥11,000/中立¥16,000/強気¥24,000)で予想。1パック240円への値上げ、新レアリティL-SP、四皇テーマ、過去の周年記念弾(OP-05/OP-09/OP-13)の実績を踏まえて、買い時・売り時の判断基準まで解説します。",
        ...
        "hero_sub": "定価¥5,760(24パック・1パック240円)の4周年タイミングの新弾。エルバフ編と四皇がテーマで、新レアリティ「スーパーリーダーパラレル(L-SP)」が初登場します。当サイトが最大10店舗から毎日自動収集している過去弾の実データをもとに、発売後のBOX相場を3シナリオで予想します。",
        "disclaimer": "本記事は2026年8月2日時点で公表されている情報と、当サイトが最大10店舗から自動取得した過去弾のBOX買取実データに基づく<strong>発売前の予想記事</strong>です。3シナリオのBOX相場・確率感は筆者の分析であり、公式発表や確定情報ではありません。収録カードの買取相場予想・封入率は各メディア(トレカの地図・トレカプロ・アルテマ等)が公開している<strong>非公式の予想値</strong>で、ソースにより数値に幅があります。封入率は公式から発表されていません。実際の相場は需給・再販・大会環境など多くの要因で大きく変動し、購入価格を下回ることもあります。投資助言を目的とするものではありません。売買の判断はご自身の責任で行ってください。実際のBOX買取価格は発売後に当サイトの実データで随時更新します。",
        "related": '<li><a href="/onepiece">ワンピBOX買取価格比較トップ</a> — 全弾のBOX買取価格を最大10店舗で横断比較(毎日更新)。OP-17も買取掲載が始まり次第反映します</li>\n'
...
<p>本記事では、当サイトが最大10店舗から毎日自動収集している<strong>過去弾のBOX買取実データ</strong>をもとに、OP-17のBOX相場を3シナリオで予想します。発売前の予想であり実際の相場は大きく変動しますが、「どのくらいの水準なら高値掴みなのか」を判断する材料としてご活用ください。</p>
...
<li>発売後の実際の買取価格は<a href="/onepiece">当サイトの最大10店舗比較</a>で毎日自動更新します。</li>
</ul>""",
        "faq": [
            {"q": "世界最強の戦士(OP-17)のBOX相場はいくらくらいになりますか？",
             "a": "発売前の予想として、当サイトでは3シナリオを想定しています。弱気¥11,000(定価の約1.9倍・直前弾OP-16の現在水準)、中立¥16,000(約2.8倍・最有力)、強気¥24,000(約4.2倍・過去の8月弾の現在水準)です。いずれも定価¥5,760を基準とした試算で、実際の相場は発売後の需給・再販で大きく変動します。発売後は当サイトの最大10店舗比較で実データを毎日更新します。"},
...
<h3>新弾を定価で手に入れる方法</h3>\n<p>BOXを定価で買えるかどうかで、ここまでの計算は大きく変わります。Amazonでは人気弾が<strong>招待リクエスト(抽選)</strong>の対象になっており、当たれば定価で購入できます。11月21日発売の<strong>OP-18「神の支配」</strong>も受付中です。どの弾が対象になっていて、定価と現在の買取価格にどれだけ差があるかは<a href=\"chusen-matome.html\" style=\"color:var(--accent);font-weight:700\">Amazon抽選(招待リクエスト)まとめ</a>で毎日更新しています。</p>\n\n<h2>購入・売却時の注意点</h2>
...
<h3>引いたカードとBOXの保管</h3>\n<p>高額カードを引いた場合も、未開封BOXを寝かせる場合も、<strong>保管状態がそのまま売却額に響きます</strong>。実測では<strong>シュリンクを剥がすだけで買取が平均12.3%下がり</strong>、高額な弾では9,000円の差が付きます。湿気による反りや、2026年8月に各地で起きた記録的な大雨をふまえた置き場所の注意は<a href=\"box-hokan.html\" style=\"color:var(--accent);font-weight:700\">ワンピカードBOXの保管方法</a>にまとめています。</p>\n\n<h3>キャンペーン非実施の店舗がある</h3>
...
<p>無料配布のプロモとはいえ、傷み・折れがあれば当然価値は下がります。開封する場合はスリーブに入れる、未開封で保管する場合はパックに折り目を付けないなど、通常のカードと同じ扱いを心がけてください。</p>""",
    ...
    },
    {
        ...
        "meta_desc": "ワンピースカード最高峰の1枚「モンキー・D・ルフィ コミックパラレル(ニカルフィ/OP05-119)」を単体で徹底解説。2026年9月1日時点の買取65万円・販売84.8万円・PSA10相場132万円という現在地、24カートン(288BOX)に約1枚という通常コミパラの4倍低い封入率、PSA10取得率71.7%が意味する状態難、直近3ヶ月で110万→80万に振れた価格推移、見分け方と売買の注意点までデータで整理します。",
        ...
        "related": '<li><a href="op-05-atari-guide.html">新時代の主役(OP-05) 当たりカードガイド</a> — 収録弾の当たり全体と封入率</li>\n'
                   ...
                   '<li><a href="/onepiece">ワンピBOX買取価格比較トップ</a> — 全弾のBOX買取価格を最大10店舗で横断比較</li>',
...
<p>本記事では、このカード1枚に絞って<strong>現在の買取・販売・PSA10相場、封入率、鑑定データ、価格推移、売買の注意点</strong>を整理します。相場は<strong>2026年9月1日時点</strong>の実測値です。</p>

<div class="callout"><strong>3行まとめ:</strong><br>
・買取<strong>約65万円</strong>／販売約84.8万円／PSA10相場<strong>約132万円</strong>(2026年9月1日時点)<br>
...
<h2>現在の相場(2026年9月1日時点)</h2>
<table class="price-table">
<thead><tr><th>区分</th><th style="text-align:right">金額</th><th>備考</th></tr></thead>
<tbody>
<tr class="best"><td><strong>買取価格</strong></td><td class="price"><strong>約¥650,000</strong></td><td>素体(未鑑定)</td></tr>
<tr><td>販売価格</td><td class="price">約¥848,000</td><td>素体(未鑑定)</td></tr>
<tr><td>PSA10相場</td><td class="price">約¥1,320,000</td><td>2026年8月30日更新</td></tr>
</tbody>
</table>

<p>素体の買取65万円に対してPSA10が132万円と、<strong>鑑定で約2.0倍</strong>になる計算です。ただし後述のとおりこのカードはPSA10取得率が低く、鑑定に出して10が付かなければ差額は取れません。</p>
...
<div class="callout"><strong>288BOXがどれくらいか:</strong> OP-05のBOX定価は¥5,280。288BOX買うと単純計算で<strong>約152万円</strong>です。買取65万円のカードを自引きで狙うのは、期待値でまったく見合いません。「BOXを買って当てる」より「カードを直接買う」ほうが安いという、高額コミパラに共通する構図です。BOX相場は<a href="box/op-05.html">OP-05個別ページ</a>で毎日更新しています。</div>
...
<tr><td>2026年8月25日</td><td class="price">約¥800,000</td><td>ピークから約27%下落</td></tr>
<tr class="best"><td><strong>2026年9月1日</strong></td><td class="price"><strong>約¥650,000</strong></td><td>ピークから約41%下落</td></tr>
</tbody>
</table>

<p>5月の55万円から6月に110万円へ<strong>2倍に急騰</strong>し、その後8月に80万円、9月1日には65万円まで下げています。<strong>1ヶ月で倍になり、そこから2ヶ月半で4割下げた</strong>ことになり、値動きの荒さがそのまま数字に出ています。</p>
...
<p>OP-05には同じニカルフィのカードが複数あり、<strong>シークレットパラレル(SEC-P)</strong>との取り違えが起こりがちです。相場は桁が違い、SECパラレルの買取は約1.5万円です。フリマの出品で「ニカルフィ パラレル」とだけ書かれている場合は、<strong>背景がコマかどうか</strong>と<strong>型番OP05-119</strong>の両方を必ず確認しましょう。</p>
...
<li><strong>複数店を比較する</strong> — 65万円クラスでは店舗間の差がそのまま数万円〜十数万円になります。1店舗の提示で決めないのが基本です。</li>
...
<li><strong>BOX買いで狙わない</strong> — 288BOXに1枚の封入率では、自引きを狙う費用がカードの価格を大きく上回ります。</li>
        ...
        "faq": [
            {"q": "ニカルフィ コミパラ(OP05-119)の買取価格はいくらですか？",
             "a": "2026年9月1日時点で買取約80万円、販売約99.8万円、PSA10相場は約133万円です(altema掲載のカードラッシュ価格基準)。ただし2026年6月には買取110万円をつけており、直近3ヶ月で大きく振れています。売却時は最新の買取表と数ヶ月の推移の両方を確認してください。"},
    ...
    },
    {
        ...
        "meta_desc": "ワンピースカードの現在最高額帯「レッドコミックパラレル(レッドスーパーパラレル)」3種を徹底解説。受け継がれる意志(OP-13)収録のルフィOP13-118・エースOP13-119・サボOP13-120について、2026年9月1日時点の買取180万/65万/50万、PSA10相場342万/107万/85万、鑑定枚数と取得率、狙いの1枚が約631BOXに1枚という封入率、発売から1年で9倍になった価格推移までデータで整理します。",
        ...
        "hero_sub": "受け継がれる意志(OP-13)収録。3周年記念の特別仕様「レッドスーパーパラレル」で、ルフィ・エース・サボのASL3兄弟がそろって最高額帯を形成しています。狙いの1枚を自引きする確率は約631BOXに1枚。相場・鑑定データは2026年9月1日時点。",
...
・ルフィは発売から1年で<strong>25万円→180万円(約7.2倍)</strong>。ただし直近ピーク250万からは調整局面</div>
...
<tbody>
<tr class="best"><td><strong>ルフィ(OP13-118)</strong></td><td class="price"><strong>約¥1,800,000</strong></td><td class="price">約¥2,380,000</td><td class="price">約¥3,420,000</td></tr>
<tr><td>エース(OP13-119)</td><td class="price">約¥650,000</td><td class="price">約¥848,000</td><td class="price">約¥1,070,000</td></tr>
<tr><td>サボ(OP13-120)</td><td class="price">約¥500,000</td><td class="price">約¥648,000</td><td class="price">約¥850,000</td></tr>
</tbody>
</table>
...
<div class="callout"><strong>結論は明快:</strong> ルフィのレッドコミパラを自引きで狙うと、BOX代の期待値は<strong>約333万円</strong>。カードの買取額180万円・販売価格238万円を大きく上回ります。<strong>欲しいなら開封ではなくカードを直接買うほうが安い</strong>という、高額パラレルに共通する結論です。もちろん開封には当てる楽しみがありますが、収支だけで見れば不利です。BOX相場は<a href="box/op-13.html">OP-13個別ページ</a>で毎日更新しています。</div>
...
<tr><td>2026年8月25日</td><td class="price">約¥2,300,000</td><td>ピークから約8%調整</td></tr>
<tr class="best"><td><strong>2026年9月1日</strong></td><td class="price"><strong>約¥1,800,000</strong></td><td>ピークから約28%下落</td></tr>
</tbody>
</table>

<p>初動25万円から1年で<strong>約7.2倍</strong>。ただし一本調子ではなく、<strong>110万→85万(-23%)</strong>のような大きな押し目を挟みながら切り上げてきました。</p>

<h3>エース・サボ</h3>
<p>エースは初動18万円から2026年1月に65万円、6月以降は80万円で推移し、9月1日時点は65万円。サボは初動15万円から2026年1月に50万円、6月に65万円をつけ、現在50万円です。<strong>両者ともルフィのような爆発的な上昇はなく、緩やかに水準を切り上げてから高値圏で安定</strong>という推移です。</p>
...
<p>OP-13には<strong>通常のコミックパラレル版のルフィ・エース</strong>も収録されています(買取はルフィ約23万円、エース約10万円)。レッドコミパラとは<strong>相場が7倍以上違う</strong>ため、取り違えは致命的です。</p>
...
<li><strong>鑑定済みを選ぶ</strong> — 180万円クラスの取引で素体を個人間でやり取りするリスクは大きく、PSA10なら真贋と状態が担保されます。鑑定の料金・取得率・出すべきかの判断は <a href="psa-guide.html">ワンピースカードのPSA鑑定ガイド</a> を参照してください。</li>
...
<li><strong>開封で狙わない</strong> — 631BOX(約333万円相当)に1枚という封入率では、カードを直接買うほうが安く済みます。</li>
        ...
        "faq": [
            ...
            {"q": "3種の買取価格はいくらですか？",
             "a": "2026年9月1日時点で、ルフィ約230万円、エース約80万円、サボ約60万円です(altema掲載のカードラッシュ買取価格基準)。PSA10相場はそれぞれ約342万円・約130万円・約84万円。同じレアリティ・同じ弾でもルフィがエースの約2.9倍と突出しており、これはキャラクター人気と主人公補正によるものです。"},
    ...
    },
    {
        ...
        "meta_desc": "ワンピースカード初のゴールド仕様「ゴール・D・ロジャー コミックパラレル(OP09-118)」を単体で徹底解説。2026年9月1日時点の買取55万・販売79.8万・PSA10相場102万、PSA10鑑定1,159枚と取得率89.6%、コミパラ5種構成ゆえロジャー単体は約360BOXに1枚という封入率、初動55万から25万へ半値以下に沈み再び70万へ戻した特異な価格推移、見分け方と売買の注意点をデータで整理します。",
        ...
        "hero_sub": "新たなる皇帝(OP-09)収録、2周年記念の初ゴールド仕様コミックパラレル。発売初動55万円から2025年11月には25万円まで沈み、そこから約2.8倍に戻した特異な値動きが特徴です。相場・鑑定データは2026年9月1日時点。",
        "disclaimer": "本記事のカード相場は<strong>2026年9月1日時点</strong>にカード相場メディア altema が掲載する<strong>カードラッシュの買取・販売価格</strong>、およびPSA10相場(2026年8月19日更新)を基準にした目安です。1店舗の価格を基準にしているため、他店の買取額や実際の取引価格とは異なります。封入率は公式発表ではなく、開封報告等に基づく推定値です。高額カードは状態(センタリング・キズ・白かけ)により査定額が大きく変わり、記載の金額を保証するものではありません。BOX買取価格は当サイトが最大9店舗から自動取得した実データです。売買の判断はご自身の責任で行ってください。",
...
<p>本記事では、このカード1枚に絞って<strong>現在の相場・封入率・PSA10データ・価格推移・売買の注意点</strong>を整理します。相場は<strong>2026年9月1日時点</strong>の実測値です。</p>

<div class="callout"><strong>3行まとめ:</strong><br>
・買取<strong>約55万円</strong>／販売約79.8万円／PSA10相場<strong>約102万円</strong>(2026年9月1日時点)<br>
...
<thead><tr><th>区分</th><th style="text-align:right">金額</th><th>備考</th></tr></thead>
<tbody>
<tr class="best"><td><strong>買取価格</strong></td><td class="price"><strong>約¥550,000</strong></td><td>素体(未鑑定)</td></tr>
<tr><td>販売価格</td><td class="price">約¥798,000</td><td>素体(未鑑定)</td></tr>
<tr><td>PSA10相場</td><td class="price">約¥1,020,000</td><td>2026年8月30日更新</td></tr>
</tbody>
</table>
...
<table class="price-table">
<thead><tr><th>OP-09のコミパラ5種</th><th style="text-align:right">買取価格(2026年9月1日)</th></tr></thead>
<tbody>
<tr class="best"><td><strong>ゴール・D・ロジャー(ゴールド)</strong></td><td class="price"><strong>約¥700,000</strong></td></tr>
<tr><td>モンキー・D・ルフィ</td><td class="price">約¥230,000</td></tr>
<tr><td>シャンクス</td><td class="price">約¥130,000</td></tr>
<tr><td>マーシャル・D・ティーチ</td><td class="price">約¥120,000</td></tr>
<tr><td>バギー</td><td class="price">約¥90,000</td></tr>
</tbody>
</table>

<p>コミパラ枠を5種で分け合うため、<strong>ロジャー1種を狙う確率は本来の約5分の1</strong>、BOX換算で<strong>約360BOXに約1枚</strong>という水準になります。</p>

<div class="callout"><strong>BOX代に換算すると:</strong> OP-09のBOX定価は¥5,280。360BOX買えば<strong>約190万円</strong>です。買取55万円・販売79.8万円のカードを自引きで狙うには、まったく見合いません。<strong>欲しいならカードを直接買う</strong>ほうが安く済みます。BOX相場は<a href="box/op-09.html">OP-09個別ページ</a>で毎日更新しています。</div>
...
<tr><td>2026年8月25日</td><td class="price">約¥700,000</td><td>底値から約2.8倍</td></tr>
<tr class="best"><td><strong>2026年9月1日</strong></td><td class="price"><strong>約¥550,000</strong></td><td>1週間で-21%</td></tr>
</tbody>
</table>

<p>このカードの値動きは、ほかの高額コミパラと明確に違います。<strong>発売から1年2ヶ月かけて初動の半値以下(25万円)まで沈み、そこから9ヶ月で2.8倍まで戻したあと、直近1週間で-21%と反落した</strong>という推移です。</p>

<div class="callout"><strong>この推移が示すもの:</strong> 記念弾のトップレアでも、<strong>発売直後に買うと1年以上含み損を抱える可能性がある</strong>ということです。一方で、25万円の底値圏で拾えていれば現在55万円。<strong>高額カードでも「発売直後が高値」とは限らない</strong>という、実データに基づく典型例といえます。<a href="red-comipara-guide.html">レッドコミパラ</a>のような右肩上がり型とは対照的です。</div>
...
<h3>偽物(レプリカ)対策</h3>
<p>本物にはレリーフ加工による表面の凹凸があり、キャラクターが浮き上がって見えます。偽物は立体感が乏しく、裏面の青が<strong>紫がかっている</strong>ことが多いとされています。55万円クラスでは<strong>鑑定済みを買う・実店舗で現物を確認する</strong>のが安全です。</p>

<h2>売買の注意点</h2>
<ul>
<li><strong>型番で確認する</strong> — OP09-118がゴールドコミパラです。同じロジャーでもSECパラレルとは相場が大きく異なります。</li>
<li><strong>推移の位置を意識する</strong> — 底値25万円から一度2.8倍まで戻し、直近1週間で-21%調整した55万円という位置にあります。過去に初動割れを経験しているカードなので、高値掴みには注意が必要です。</li>
...
<li><strong>複数店を比較する</strong> — 55万円クラスでは店舗差が数万円〜十数万円になります。</li>
<li><strong>開封で狙わない</strong> — 360BOX(約190万円相当)に1枚では、カードを直接買うほうが安く済みます。</li>
</ul>""",
        "faq": [
            {"q": "ロジャー ゴールドコミパラ(OP09-118)の買取価格はいくらですか？",
             "a": "2026年9月1日時点で買取約70万円、販売約89.8万円、PSA10相場は約109万円です(altema掲載のカードラッシュ価格基準)。2025年11月には約25万円まで下落した時期があり、そこから約2.8倍に戻した水準にあります。"},
            {"q": "封入率はどのくらいですか？",
    ...
    },
    {
        ...
        "meta_desc": "ワンピースカードのコミックパラレル(スーパーパラレル)を全23弾横断でランキング。2026年9月1日時点の買取価格で弾別最高額とカード単体TOP12を一覧化し、上位12枚のうち5枚をルフィが占める主人公補正、コミパラが複数種ある弾ほど1種あたりが希少になる構造、そして当サイトが最大10店舗から毎日自動取得しているBOX買取実データと突き合わせて「トップレアが高い弾＝BOXも高い」が成立しない理由まで解説します。",
        ...
        "hero_sub": "ワンピースカードの実質的な最高レアリティ「コミックパラレル(スーパーパラレル)」を全23弾横断で比較。首位はルフィのレッドコミパラ(OP-13)。カード相場は2026年9月1日時点、BOX買取価格は当サイトが最大10店舗から毎日自動取得している実データです。",
...
<p>本記事では、<strong>全23弾のコミパラを横断でランキング</strong>し、そのうえで<strong>当サイトが最大10店舗から毎日自動取得しているBOX買取実データと突き合わせて</strong>、「トップレアが高い弾はBOXも高いのか」を検証します。カード相場は<strong>2026年9月1日時点</strong>の実測値です。</p>

<div class="callout"><strong>3行まとめ:</strong><br>
・首位は<strong>ルフィ レッドコミパラ(OP-13)の180万円</strong>。2位以下を2.8倍引き離して独走<br>
・カード単体TOP12のうち<strong>5枚がルフィ</strong>。主人公補正がそのまま相場に出ている<br>
・<strong>コミパラ最高額とBOX買取価格は連動しない</strong>。トップレア180万円のOP-13よりBOXが高い弾がいくつもある</div>
...
<tbody>
<tr class="best"><td>1位</td><td><a href="op-13-atari-guide.html">受け継がれる意志(OP-13)</a></td><td><strong>モンキー・D・ルフィ</strong><br><span style="font-size:11px;color:#6b7280">レッドコミパラ</span></td><td class="price"><strong>¥1,800,000</strong></td></tr>
<tr><td>2位</td><td><a href="op-05-atari-guide.html">新時代の主役(OP-05)</a></td><td>モンキー・D・ルフィ(ニカ)</td><td class="price">¥650,000</td></tr>
<tr><td>3位</td><td><a href="op-09-atari-guide.html">新たなる皇帝(OP-09)</a></td><td>ゴール・D・ロジャー<br><span style="font-size:11px;color:#6b7280">ゴールド仕様</span></td><td class="price">¥550,000</td></tr>
<tr><td>4位</td><td><a href="eb-02-atari-guide.html">Anime 25th collection(EB-02)</a></td><td>モンキー・D・ルフィ</td><td class="price">¥350,000</td></tr>
<tr><td>5位</td><td><a href="op-06-atari-guide.html">双璧の覇者(OP-06)</a></td><td>ロロノア・ゾロ</td><td class="price">¥200,000</td></tr>
<tr><td>5位</td><td><a href="eb-01-atari-guide.html">メモリアルコレクション(EB-01)</a></td><td>トニートニー・チョッパー</td><td class="price">¥200,000</td></tr>
<tr><td>7位</td><td><a href="op-17-atari-guide.html">世界最強の戦士(OP-17)</a></td><td>シャンクス</td><td class="price">¥180,000</td></tr>
<tr><td>8位</td><td><a href="op-16-atari-guide.html">決戦の刻(OP-16)</a></td><td>サカズキ</td><td class="price">¥170,000</td></tr>
<tr><td>9位</td><td><a href="op-07-atari-guide.html">500年後の未来(OP-07)</a></td><td>ボア・ハンコック</td><td class="price">¥140,000</td></tr>
<tr><td>10位</td><td><a href="op-01-atari-guide.html">ROMANCE DAWN(OP-01)</a></td><td>シャンクス</td><td class="price">¥130,000</td></tr>
<tr><td>11位</td><td><a href="op-02-atari-guide.html">頂上決戦(OP-02)</a></td><td>ポートガス・D・エース</td><td class="price">¥120,000</td></tr>
<tr><td>11位</td><td><a href="op-11-atari-guide.html">神速の拳(OP-11)</a></td><td>モンキー・D・ルフィ</td><td class="price">¥120,000</td></tr>
<tr><td>13位</td><td><a href="prb-02-atari-guide.html">THE BEST vol.2(PRB-02)</a></td><td>サンジ</td><td class="price">¥100,000</td></tr>
<tr><td>14位</td><td><a href="op-03-atari-guide.html">強大な敵(OP-03)</a></td><td>そげキング</td><td class="price">¥80,000</td></tr>
<tr><td>14位</td><td><a href="op-04-atari-guide.html">謀略の王国(OP-04)</a></td><td>サボ</td><td class="price">¥80,000</td></tr>
<tr><td>14位</td><td><a href="op-12-atari-guide.html">師弟の絆(OP-12)</a></td><td>ジュエリー・ボニー</td><td class="price">¥80,000</td></tr>
<tr><td>14位</td><td><a href="eb-03-atari-guide.html">Heroines Edition(EB-03)</a></td><td>ウタ</td><td class="price">¥80,000</td></tr>
<tr><td>14位</td><td><a href="eb-04-atari-guide.html">EGGHEAD CRISIS(EB-04)</a></td><td>コビー</td><td class="price">¥80,000</td></tr>
<tr><td>14位</td><td><a href="prb-01-atari-guide.html">THE BEST(PRB-01)</a></td><td>ナミ</td><td class="price">¥80,000</td></tr>
<tr><td>20位</td><td><a href="op-10-atari-guide.html">王族の血統(OP-10)</a></td><td>トラファルガー・ロー</td><td class="price">¥70,000</td></tr>
<tr><td>20位</td><td><a href="op-14-atari-guide.html">蒼海の七傑(OP-14)</a></td><td>ジュラキュール・ミホーク</td><td class="price">¥70,000</td></tr>
<tr><td>20位</td><td><a href="op-15-atari-guide.html">神の島の冒険(OP-15)</a></td><td>エネル</td><td class="price">¥70,000</td></tr>
<tr><td>23位</td><td><a href="op-08-atari-guide.html">二つの伝説(OP-08)</a></td><td>シルバーズ・レイリー</td><td class="price">¥60,000</td></tr>
</tbody>
</table>

<p>最高額のOP-13(180万円)と最下位のOP-08(6万円)では<strong>約30倍</strong>の開きがあります。同じ最高レアリティ枠でも、弾によってここまで差が出るのがワンピースカードの特徴です。</p>

<p>なお<a href="op-17-atari-guide.html">世界最強の戦士(OP-17)</a>は四皇4種のコミパラを収録しているため本ランキングに含めていますが、同弾の最高額である新レアリティ「海賊団スーパーパラレル」(ルフィ180万円・ロックス70万円)は従来のコミパラ枠とは別系統のため対象外としています。スタートデッキEX(ST-30)にはコミパラの収録がありません。</p>
...
<tbody>
<tr class="best"><td>1位</td><td><strong>モンキー・D・ルフィ</strong> レッドコミパラ</td><td>OP-13</td><td class="price"><strong>¥1,800,000</strong></td></tr>
<tr><td>2位</td><td><strong>モンキー・D・ルフィ(ニカ)</strong></td><td>OP-05</td><td class="price">¥650,000</td></tr>
<tr><td>2位</td><td>ポートガス・D・エース レッドコミパラ</td><td>OP-13</td><td class="price">¥650,000</td></tr>
<tr><td>4位</td><td>ゴール・D・ロジャー ゴールド</td><td>OP-09</td><td class="price">¥550,000</td></tr>
<tr><td>5位</td><td>サボ レッドコミパラ</td><td>OP-13</td><td class="price">¥500,000</td></tr>
<tr><td>6位</td><td><strong>モンキー・D・ルフィ</strong></td><td>EB-02</td><td class="price">¥350,000</td></tr>
<tr><td>7位</td><td><strong>モンキー・D・ルフィ</strong></td><td>OP-13</td><td class="price">¥230,000</td></tr>
<tr><td>7位</td><td><strong>モンキー・D・ルフィ</strong></td><td>OP-09</td><td class="price">¥230,000</td></tr>
<tr><td>9位</td><td>ロロノア・ゾロ</td><td>OP-06</td><td class="price">¥200,000</td></tr>
<tr><td>9位</td><td>トニートニー・チョッパー</td><td>EB-01</td><td class="price">¥200,000</td></tr>
<tr><td>11位</td><td>シャンクス</td><td>OP-17</td><td class="price">¥180,000</td></tr>
<tr><td>12位</td><td>サカズキ</td><td>OP-16</td><td class="price">¥170,000</td></tr>
</tbody>
</table>

<h2>分析①｜TOP12のうち5枚がルフィ</h2>
<p>上のランキングを見ると、<strong>12枠のうち5枠をモンキー・D・ルフィが占めています</strong>(1位・2位・6位・7位×2、ニカ版を含む)。2位のエース、5位のサボを加えると、<strong>ASL3兄弟だけで7枠</strong>です。</p>

<div class="callout"><strong>何を意味するか:</strong> コミパラの相場は<strong>封入率よりキャラクター人気で決まる</strong>ということです。封入率は基本的にどのコミパラも同じ枠から出るため、価格差の説明にはなりません。実際、同じ弾・同じレアリティのレッドコミパラ3種でも、ルフィ180万・エース65万・サボ50万と<strong>3.6倍の差</strong>がついています(詳細は<a href="red-comipara-guide.html">レッドコミパラ3種徹底解説</a>)。</div>
...
<p>ここからが当サイト独自の検証です。当サイトは<strong>最大10店舗のBOX買取価格を毎日自動取得</strong>しています。「トップレアが高い弾はBOXも高いはず」という直感が正しいかを、実データで確かめてみます。</p>
...
<li><strong><a href="roger-gold-comipara.html">ロジャー ゴールドコミパラ(OP09-118)徹底解説</a></strong> — ランキング4位。初動55万から25万に沈み70万へ戻した特異な価格推移</li>
        ...
        "faq": [
            ...
            {"q": "歴代でもっとも高いコミパラはどれですか？",
             "a": "2026年9月1日時点では、受け継がれる意志(OP-13)のモンキー・D・ルフィ レッドコミパラで買取約230万円です。2位グループのエース レッドコミパラ(OP-13)とニカルフィ(OP-05)がともに約80万円なので、1位が2位以下を約2.9倍引き離しています。最下位のOP-08レイリー(約6万円)とは約38倍の差があります。"},
            {"q": "なぜルフィのコミパラは高いのですか？",
            ...
            {"q": "コミパラが高い弾はBOXも高いですか？",
             "a": "連動しません。当サイトが最大10店舗から毎日取得しているBOX買取実データと突き合わせると、コミパラ最高額1位のOP-13よりBOX買取が高い弾がいくつもあります。理由は、BOX価格が市場に残る未開封在庫の量に強く左右されること、OP-11の3周年スペシャル(金)のようにコミパラ以外の高額枠が開封需要を牽引する弾があること、そしてカードは減らないがBOXは開封で減るという非対称性の3点です。カードを狙うならカード相場を、BOXを狙うならBOX相場を別々に確認してください。"},
        ],
    },
    {
        "slug": "psa-guide",
        ...
        "meta_desc": "ワンピースカードをPSA鑑定に出すべきか、実データで判断するためのガイド。素体買取とPSA10相場の倍率(1.65〜2.03倍)、カードごとに大きく違うPSA10取得率(ニカルフィ71.7%〜フラシウタ93.2%)、鑑定料と返却待ちを織り込んだ期待値の考え方、センタリング55/45などの提出前セルフチェック、そして「PSA10相場は販売価格であって買取価格ではない」という最大の落とし穴まで、2026年9月1日時点の実測値で整理します。",
...
<p>本記事では、精神論ではなく<strong>実際の数値</strong>で判断できるように整理します。素体の買取価格・PSA10相場・鑑定枚数・PSA10取得率は、いずれも<strong>2026年9月1日時点</strong>の実測値です。</p>

<div class="callout"><strong>3行まとめ:</strong><br>
・素体買取に対するPSA10相場の倍率は<strong>1.65〜2.03倍</strong>。8月下旬の1.40〜1.66倍から拡大した<br>
...
<p>ワンピースカードのように<strong>数十万〜数百万円のカードが存在するタイトル</strong>では、真贋の担保という意味でも鑑定の価値があります。個人間で180万円クラスのカードを素体でやり取りするリスクを考えれば、スラブ入りであること自体が取引の前提になる価格帯です。</p>
...
<div class="callout"><strong>高額カードほど料金は上がる:</strong> PSAのプランは<strong>申告価値(そのカードの想定価値)によって使えるプランが決まります</strong>。レギュラーの申告価値上限は25万円程度とされており、<a href="red-comipara-guide.html">ルフィのレッドコミパラ(素体買取180万円)</a>のようなカードは、より上位の高額プランを使う必要があります。「4,980円で出せる」と考えていると計算が狂うので、<strong>自分のカードの価格帯でいくらかかるかを事前に確認</strong>してください。</div>
...
<tbody>
<tr class="best"><td><a href="nika-luffy-comipara.html">ニカルフィ コミパラ</a></td><td>OP-05</td><td class="price">¥650,000</td><td class="price">¥1,320,000</td><td class="price"><strong>2.03倍</strong></td></tr>
<tr><td><a href="red-comipara-guide.html">ルフィ レッドコミパラ</a></td><td>OP-13</td><td class="price">¥1,800,000</td><td class="price">¥3,420,000</td><td class="price">1.90倍</td></tr>
<tr><td><a href="roger-gold-comipara.html">ロジャー 金コミパラ</a></td><td>OP-09</td><td class="price">¥550,000</td><td class="price">¥1,020,000</td><td class="price">1.85倍</td></tr>
<tr><td><a href="eb02-luffy-comipara.html">ルフィ コミパラ</a></td><td>EB-02</td><td class="price">¥350,000</td><td class="price">¥641,000</td><td class="price">1.83倍</td></tr>
<tr><td><a href="red-comipara-guide.html">サボ レッドコミパラ</a></td><td>OP-13</td><td class="price">¥500,000</td><td class="price">¥850,000</td><td class="price">1.70倍</td></tr>
<tr><td><a href="red-comipara-guide.html">エース レッドコミパラ</a></td><td>OP-13</td><td class="price">¥650,000</td><td class="price">¥1,070,000</td><td class="price">1.65倍</td></tr>
</tbody>
</table>

<p>倍率は<strong>1.65〜2.03倍のレンジ</strong>で、<strong>おおむね1.8倍前後</strong>です。注目したいのは、1週間前(8月25日時点)の同じ集計が1.40〜1.66倍だったことです。<strong>素体の買取価格が1週間で2〜3割下げたのに対し、PSA10相場の下げが緩やかだったため、倍率のほうが押し上げられました</strong>。倍率は「PSA10の価値が上がった」ときだけでなく、「素体が下げた」ときにも広がります。</p>
...
<h3>ケース1: サボ レッドコミパラ(取得率90.2%・倍率1.70)</h3>
<p>期待値＝0.902×85万円＋0.098×50万円＝<strong>約81.6万円</strong>。素体売却の50万円に対して<strong>約32万円のプラス</strong>で、鑑定料を引いても十分に見合う計算です。</p>

<h3>ケース2: ニカルフィ コミパラ(取得率71.7%・倍率2.03)</h3>
<p>期待値＝0.717×132万円＋0.283×65万円＝<strong>約113.0万円</strong>。素体売却の65万円に対して<strong>約48万円のプラス</strong>。倍率が高いぶん、取得率が低くても数字上はプラスに出ます。</p>
...
<tbody>
<tr><td>素体 買取 ¥650,000</td><td>あなたが<strong>店に売る</strong>ときに受け取る額</td></tr>
<tr class="best"><td>PSA10 相場 ¥1,320,000</td><td>店が<strong>売る</strong>ときの値段(あなたの受取額ではない)</td></tr>
</tbody>
</table>

<p>PSA10を店に売る場合、買取価格は販売価格から相応に引かれます。ワンピースカードの素体では、販売価格に対して買取が<strong>7〜8割程度</strong>という水準が一般的です(たとえばニカルフィは販売84.8万円に対し買取65万円で約77%、ロジャーは販売79.8万円に対し買取55万円で約69%)。</p>

<p>同じ比率がPSA10にも当てはまると仮定すると、ニカルフィのPSA10買取は<strong>132万円×0.77＝約102万円</strong>。ここから鑑定料を引き、取得率71.7%を掛け直すと、素体売却65万円との差はかなり縮みます。</p>
...
<li><strong>安いカードは費用倒れになりやすい</strong> — 倍率が1.8倍前後である以上、素体で数万円のカードは鑑定料と手間に見合わないことが多くなります。</li>
...
<li><strong>すでにPSA10が多いカードもある</strong> — ナミ パラレル(OP-01)は7,824枚、サインルフィは3,331枚がPSA10になっています。希少性そのものが薄れている枠もあると理解しておきましょう。</li>
        ...
        "faq": [
            {"q": "ワンピースカードをPSA10にすると、どのくらい価値が上がりますか？",
             "a": "2026年9月1日時点の実データでは、素体の買取価格に対してPSA10相場は1.40〜1.66倍です(ニカルフィ1.66倍、エース レッドコミパラ1.63倍、ロジャー金1.56倍、ルフィ レッドコミパラ1.49倍、サボ レッドコミパラ1.40倍)。「倍以上になる」というイメージより控えめで、おおむね1.5倍前後と考えるのが実態に近い水準です。"},
    ...
    },
    {
        ...
        "meta_desc": "当サイトが最大10店舗から毎日自動取得しているワンピースカードのBOX買取実データで、全弾の値動きを横断分析。同じ期間にカード相場は全弾が下落したにもかかわらず、BOX相場は上昇と下落がほぼ拮抗しました。下落が直近弾に集中し古い弾ほど堅いという傾向、そこから読み取れる供給量の構造、買い時・売り時の考え方までを実測値で整理します。",
        "og_title": "ワンピBOX相場の値動きパターン｜新しい弾ほど下がる傾向を実データで",
        "og_desc": "最大10店舗のBOX買取実データで全弾の値動きを横断分析。カード相場が全弾下落した期間もBOXは拮抗。下落が直近弾に集中する傾向と、買い時・売り時の考え方。",
        "meta_line": "全弾のBOX買取値動き実測・パターン分析・売買タイミング",
        "hero_label": "ワンピBOX相場 値動きレポート",
        "hero_big": "上昇{{CHG_UP}} / 下落{{CHG_DOWN}} / 横ばい{{CHG_FLAT}}",
        "hero_sub": "当サイトが最大10店舗から毎日自動取得しているBOX買取実データで、全{{CHG_N}}弾の値動きを横断集計しました({{CHG_PERIOD}}時点)。平均変化率は{{CHG_AVG}}。同じ期間にカード相場は全弾が下落しており、BOXとカードが別の動きをしていることが実測で確認できます。",
        "disclaimer": "本記事のBOX買取価格は、当サイトが最大9店舗から自動取得した実データです。各弾の「最高買取価格」(掲載店舗のうち最も高い店の価格)を用いており、店舗ごとの価格差や、掲載店舗の増減による変動を含みます。集計期間は当サイトのワンピ価格履歴が蓄積されている範囲に限られ、長期のトレンドを断定できるだけの期間ではありません。値動きの<strong>理由</strong>については、再販や出荷の実施状況を公開情報で確認できた範囲を超えて断定していません(バンダイは個別弾の再販を網羅的に公表していないため)。カード相場に関する記述は altema 掲載のカードラッシュ買取価格(2026年9月1日時点)を基準にした比較です。相場は今後も変動し、本記事の傾向が継続することを保証するものではありません。売買の判断はご自身の責任で行ってください。",
        "related": '<li><a href="/onepiece">ワンピBOX買取価格比較トップ</a> — 全弾のBOX買取価格を最大10店舗で横断比較(毎日更新)</li>\n'
                   '<li><a href="weekly.html">週間値動きランキング</a> — 直近7日間の値上がり・値下がりを毎日自動更新</li>\n'
                   '<li><a href="kougaku-ranking.html">高額BOXランキング・絶版ガイド</a> — 全弾の最高買取・定価比ランキング</li>\n'
        ...
        "body": """<p>「ワンピースカードのBOXは今、上がっているのか下がっているのか」——この問いに、<strong>当サイトが最大10店舗から毎日自動取得しているBOX買取の実データ</strong>で答えます。</p>
...
<ul>
<li><strong>新しい弾は供給が続いている</strong> — 発売から間もない弾は追加出荷や再販がかかりやすく、市場の未開封在庫が増えます(再販の実績とチャネルは <a href="restock-guide.html">再販・入荷ガイド</a> にまとめています)。実際、OP-15については2026年4月中旬の追加出荷が販売店から案内されていました(それ以降の再販状況は当サイトでは確認できていません)。</li>
...
<li><strong>傾向は変わり得る</strong> — 本記事の数値は{{CHG_PERIOD}}時点の集計です。相場は日々動くため、最新の順位は<a href="/onepiece">比較トップ</a>、直近の値動きは<a href="weekly.html">週間値動きランキング</a>でご確認ください。</li>
    ...
    },
    {
        ...
        "date": "2026-08-25",
        "date_jp": "2026年8月25日",
        "title": "ワンピ3周年スペシャル(金/銀)徹底解説｜ルフィ金110万・ティーチ20万・バギー17万と、BOX代を上回っていた唯一のカードが失った優位",
        "h1": "ワンピ3周年スペシャルカード(金/銀)徹底解説｜ルフィ金140万・ティーチ25万・バギー18万の相場と封入率",
        "meta_desc": "ワンピースカードの3周年スペシャルカード(金/銀)全6枚を横断解説。神速の拳(OP-11)のルフィ、師弟の絆(OP-12)のティーチ、蒼海の七傑(OP-14)のバギーが金銀2種ずつ収録され、2026年9月1日時点の買取はルフィ金110万・銀50万、ティーチ金20万・銀13万、バギー金17万・銀7万。8月下旬まで金は銀の1.75〜2.00倍に収まっていた規則性が1.54〜2.43倍に広がった経緯、キャラ間で最大6.5倍の差、コミックパラレルより低い封入率、そしてルフィ金だけがBOX代換算を上回る唯一のカードである点までデータで整理します。",
...
<p>この6枚には見落とされがちな特徴があります。<strong>コミックパラレルより封入率が低いにもかかわらず、レアリティが別枠のため<a href="comipara-ranking.html">コミパラのランキング</a>には一切登場しない</strong>のです。ルフィの金は買取110万円で、実質的にワンピースカードで2番目に高い部類にあたります。</p>

<div class="callout"><strong>3行まとめ:</strong><br>
・金は銀の<strong>1.54〜2.43倍</strong>。8月下旬までは1.75〜2.00倍に収まっていたが、9月1日時点では崩れた<br>
...
<tbody>
<tr class="best"><td><strong>モンキー・D・ルフィ</strong></td><td>OP-11</td><td class="price"><strong>¥1,100,000</strong></td><td class="price">¥500,000</td><td class="price">2.20倍</td></tr>
<tr><td>マーシャル・D・ティーチ</td><td>OP-12</td><td class="price">¥200,000</td><td class="price">¥130,000</td><td class="price">1.54倍</td></tr>
<tr><td>バギー</td><td>OP-14</td><td class="price">¥170,000</td><td class="price">¥70,000</td><td class="price">2.43倍</td></tr>
</tbody>
</table>

<h2>発見①｜「金は銀の約2倍」という規則性は崩れた</h2>
<p>8月下旬まで、3枚とも金は銀の<strong>1.75〜2.00倍</strong>という狭いレンジに収まっていました。9月1日時点では<strong>ティーチ1.54倍・ルフィ2.20倍・バギー2.43倍</strong>とばらつきが広がっています。金と銀で下げ幅が違ったためで、規則性は一時的なものだったことになります。それでも「金が銀より高い」という序列自体は3枚とも変わっていません。かつての規則性は次のとおりです。キャラクターの人気も相場の絶対額もまったく違うのに、<strong>金銀の比率だけは揃っている</strong>のが興味深い点です。</p>
...
<h2>発見③｜唯一BOX代を上回っていたルフィ金も、9月1日に逆転された</h2>
...
<tbody>
<tr class="best"><td><strong>ルフィ(金)</strong></td><td class="price">約211.5BOX</td><td class="price">約¥1,117,000</td><td class="price"><strong>¥1,100,000</strong></td><td class="price" style="color:#b91c1c;font-weight:700">-約2万円</td></tr>
<tr><td>ティーチ(金)</td><td class="price">約314.8BOX</td><td class="price">約¥1,662,000</td><td class="price">¥200,000</td><td class="price" style="color:#b91c1c;font-weight:700">-約146万円</td></tr>
<tr><td>バギー(金)</td><td class="price">約274.6BOX</td><td class="price">約¥1,450,000</td><td class="price">¥170,000</td><td class="price" style="color:#b91c1c;font-weight:700">-約128万円</td></tr>
</tbody>
</table>

<p>2026年8月下旬まで、<strong>ルフィ金だけはBOX代換算をカードの買取価格が上回っていました</strong>(買取140万円 vs BOX代112万円で+28万円)。しかし9月1日時点で買取が110万円まで下げたことで、<strong>この関係はわずかながら逆転しています</strong>。BOX代は定価で固定なので、カード側が下がっただけで符号が変わった形です。なお実際に211BOXを開ければ、ルフィ金以外にも銀・コミックパラレル・SP・パラレルが大量に出るため、回収額そのものは表の数字より上振れします。</p>

<p>これは当サイトが扱ってきた他の高額カードとは対照的です。<a href="red-comipara-guide.html">レッドコミパラのルフィ</a>は約631BOX(約333万円)に1枚で買取180万円、<a href="nika-luffy-comipara.html">ニカルフィ</a>は約288BOX(約152万円)に1枚で買取65万円と、<strong>いずれも自引きが大きく不利</strong>です。3周年SPのルフィ金は<strong>8月下旬まで唯一の例外</strong>でしたが、9月1日時点ではその優位も失われました。同じ反転は<a href="eb02-luffy-comipara.html">EB-02のルフィ コミパラ</a>でも起きており(8月26日 +12万円 → 9月1日 -3万円)、<strong>高額帯が横並びで下げた結果</strong>と見るのが妥当です。</p>
...
・買取価格は日々変動します。本記事の数字は9月1日時点のスナップショットで、7月には140万円台をつけていました</div>

<p>結論としては「<strong>かつては理論上プラスだったが、いまはほぼ拮抗</strong>」というのが正確なところです。それでも他の高額カードが100万円以上のマイナスであるのに対し、ルフィ金だけが±2万円の水準に収まっている事実は変わりません。この計算が示しているのは、<strong>ルフィ金の相場が封入率に対して割高</strong>——言い換えれば<strong>人気が希少性を大きく上回って評価されている</strong>という構造です。</p>
...
<div class="callout"><strong>見落としに注意:</strong> コミパラのランキングだけを見て弾の実力を判断すると、OP-11を読み違えます。OP-11のコミパラ最高額は約12万円で全23弾中11位ですが、同じ弾に<strong>買取110万円のルフィ金</strong>が存在します。BOX買取でOP-11が上位に入っているのは、このSP枠が開封需要を牽引しているためと考えられます。</div>
...
<li><strong>ソースによる価格差が大きい</strong> — 本記事はaltema掲載のカードラッシュ買取を基準にしていますが、相場は日々動きます。売却時は必ず複数店を比較してください。</li>
...
<li><strong>BOX買いで狙うなら分散を理解する</strong> — 理論上プラスなのはルフィ金のみで、それも「平均すれば」の話です。ティーチ金・バギー金は大幅なマイナスになります。</li>
        ...
        "faq": [
            ...
            {"q": "3周年スペシャルの買取価格はいくらですか？",
             "a": "2026年9月1日時点で、ルフィ金140万円・銀80万円、ティーチ金25万円・銀13万円、バギー金18万円・銀9万円です(altema掲載のカードラッシュ買取価格基準)。金は銀の約1.75〜2.00倍という規則性があり、3枚とも例外なくこのレンジに収まっています。"},
            {"q": "なぜルフィだけこんなに高いのですか？",
    ...
    {
        "slug": "kaigun-taisho-guide",
        "nav_label": "海軍大将トリオ 徹底解説",
        "crumb": "海軍大将トリオ コミパラ(OP-16)",
        "date": "2026-08-25",
        "date_jp": "2026年8月25日",
        "title": "海軍大将トリオ コミパラ(OP-16)徹底解説｜サカズキ・クザン・ボルサリーノが横並びの理由と封入率302BOXに1枚",
        "h1": "海軍大将トリオ コミパラ(OP-16)徹底解説｜サカズキ・クザン・ボルサリーノが横並びになる理由と封入率",
        "meta_desc": "決戦の刻(OP-16)の海軍大将トリオ、サカズキ・クザン・ボルサリーノのスーパーパラレル(コミパラ)3枚を横断解説。2026年8月時点の買取はサカズキ23万・クザン23万・ボルサリーノ20万と、最大でも1.15倍差の横並び。ルフィ補正で7.8倍の差がついた3周年スペシャルとは対照的です。狙いの1枚が約302BOXに1枚という封入率、販売価格と買取価格で順位が入れ替わる現象、日本版初のトレジャーレアまでデータで整理します。",
        "og_title": "海軍大将トリオ コミパラ(OP-16)徹底解説｜3枚横並びの理由と封入率",
        "og_desc": "決戦の刻の海軍大将トリオ3枚を横断解説。買取23万・23万・20万の横並び、約302BOXに1枚の封入率、販売と買取で順位が入れ替わる現象、日本版初のトレジャーレアも。",
        "meta_line": "海軍大将トリオ3枚の相場・封入率・横並びの理由",
        "hero_label": "海軍大将トリオ スーパーパラレル【OP-16】",
        "hero_big": "3枚とも 買取 ¥150,000〜¥170,000",
        "hero_sub": "決戦の刻(OP-16)に収録された、サカズキ(赤犬)・クザン(青雉)・ボルサリーノ(黄猿)の海軍大将3人のスーパーパラレル。相場が最大でも1.13倍差に収まる「横並び」で、主人公補正が効く他の弾とは様相が異なります。相場は2026年9月1日時点。",
        "disclaimer": "本記事のカード買取価格は<strong>2026年9月1日時点</strong>にカード相場メディア altema が掲載する<strong>カードラッシュの買取価格</strong>を基準にした目安です。1店舗の買取価格のため、他店の査定額や販売価格とは異なります(別ソースの数値も本文中に併記しています)。<strong>封入率はバンダイの公式発表ではなく</strong>、開封報告等をもとにトレカ系メディアが公開している推定値で、ソースにより幅があります。BOX代換算は推定封入率に定価を掛けた机上の計算で、実際の開封結果を保証するものではありません。この確率帯では分散が大きく、目安の倍を開けても出ないことは普通に起こります。BOX買取価格は当サイトが最大9店舗から自動取得した実データです。売買・開封の判断はご自身の責任で行ってください。",
        "related": '<li><a href="op-16-atari-guide.html">決戦の刻(OP-16) 当たりカードガイド</a> — 収録弾の当たり全体と封入率</li>\n'
                   '<li><a href="box/op-16.html">決戦の刻(OP-16) BOX買取価格</a> — 店舗別のBOX買取価格を毎日更新</li>\n'
                   '<li><a href="anniversary-sp-guide.html">3周年スペシャル(金/銀)徹底解説</a> — キャラ差が7.8倍ついた対照的なケース</li>\n'
                   '<li><a href="red-comipara-guide.html">レッドコミパラ3種(OP-13)徹底解説</a> — 同じ3枚組でも3.8倍の差がついた例</li>\n'
                   '<li><a href="comipara-ranking.html">歴代コミックパラレル相場ランキング全22弾</a> — 全弾のコミパラ相場ランキング</li>\n'
                   '<li><a href="/onepiece">ワンピBOX買取価格比較トップ</a> — 全弾のBOX買取価格を最大10店舗で横断比較</li>',
        "body": """<p><a href="op-16-atari-guide.html">決戦の刻(OP-16)</a>の看板は、<strong>サカズキ(赤犬)・クザン(青雉)・ボルサリーノ(黄猿)</strong>の海軍大将3人のスーパーパラレル(コミックパラレル)です。頂上戦争編の中心人物がそろって特別仕様で収録された、海軍テーマの弾を象徴する3枚です。</p>

<p>この3枚には、当サイトがこれまで扱ってきた高額カードと明確に違う特徴があります。<strong>3枚の相場がほとんど横並び</strong>なのです。</p>

<div class="callout"><strong>3行まとめ:</strong><br>
・買取は<strong>サカズキ23万・クザン23万・ボルサリーノ20万</strong>。最大でも<strong>1.15倍差</strong>の横並び<br>
・<a href="anniversary-sp-guide.html">3周年スペシャル(7.8倍差)</a>や<a href="red-comipara-guide.html">レッドコミパラ(3.8倍差)</a>と比べると異例。<strong>主人公不在の弾</strong>であることが効いている<br>
・<strong>販売価格では順位が入れ替わる</strong>。クザンが最高値で、買取の横並びとは別の序列になっている</div>

<h2>基本情報</h2>
<table class="price-table">
<thead><tr><th>項目</th><th>内容</th></tr></thead>
<tbody>
<tr><td>カード</td><td>サカズキ / クザン / ボルサリーノ</td></tr>
<tr><td>レアリティ</td><td>スーパーパラレル(コミックパラレル)</td></tr>
<tr><td>収録</td><td><a href="op-16-atari-guide.html">ブースターパック「決戦の刻」(OP-16)</a></td></tr>
<tr><td>発売日</td><td>2026年5月30日</td></tr>
<tr><td>BOX定価</td><td>¥5,280</td></tr>
<tr><td>テーマ</td><td>頂上戦争・海軍</td></tr>
</tbody>
</table>

<h2>3枚の相場(2026年8月時点)</h2>
<table class="price-table">
<thead><tr><th>カード</th><th>異名</th><th style="text-align:right">買取</th><th style="text-align:right">販売価格の目安</th></tr></thead>
<tbody>
<tr class="best"><td><strong>サカズキ</strong></td><td>赤犬</td><td class="price"><strong>¥170,000</strong></td><td class="price">約¥248,000</td></tr>
<tr><td><strong>クザン</strong></td><td>青雉</td><td class="price"><strong>¥150,000</strong></td><td class="price">約¥218,000</td></tr>
<tr><td>ボルサリーノ</td><td>黄猿</td><td class="price">¥150,000</td><td class="price">約¥218,000</td></tr>
</tbody>
</table>
<p>買取価格・販売価格ともaltema掲載のカードラッシュ基準(2026年9月1日時点)です。8月下旬までは3枚が23万・23万・20万とほぼ同額でしたが、9月1日時点では<strong>サカズキ17万・クザン15万・ボルサリーノ15万</strong>となり、サカズキが単独トップに変わりました。それでも最高額と最低額の差は1.13倍で、<strong>「3枚が横並び」という構図自体は維持されています</strong>。</p>

<h2>発見①｜3枚が横並びなのは異例</h2>
<p>当サイトでこれまで扱ってきた「同じ弾・同じレアリティの複数枚」と比べると、この横並びぶりは際立っています。</p>

<table class="price-table">
<thead><tr><th>グループ</th><th>収録</th><th style="text-align:right">最高額</th><th style="text-align:right">最低額</th><th style="text-align:right">倍率</th></tr></thead>
<tbody>
<tr class="best"><td><strong>海軍大将トリオ</strong></td><td>OP-16</td><td class="price">¥170,000</td><td class="price">¥200,000</td><td class="price"><strong>1.15倍</strong></td></tr>
<tr><td><a href="red-comipara-guide.html">レッドコミパラ3種</a></td><td>OP-13</td><td class="price">¥1,800,000</td><td class="price">¥500,000</td><td class="price">3.83倍</td></tr>
<tr><td><a href="anniversary-sp-guide.html">3周年スペシャル(金)</a></td><td>OP-11/12/14</td><td class="price">¥1,100,000</td><td class="price">¥170,000</td><td class="price">7.78倍</td></tr>
</tbody>
</table>

<h3>なぜ横並びになるのか</h3>
<p>レッドコミパラも3周年スペシャルも、最高額のカードは<strong>いずれもモンキー・D・ルフィ</strong>でした。主人公が含まれるグループでは、ルフィが突出して他を引き離します。</p>

<p>対して海軍大将トリオには<strong>主人公が含まれていません</strong>。3人とも海軍大将という同格の立場で、作中での重要度も人気も拮抗しています。<strong>グループ内に「主人公補正」を受けるカードが存在しないため、相場が実力どおり横並びになる</strong>——というのが、データから読み取れる構図です。</p>

<div class="callout"><strong>実務的な意味:</strong> 横並びであることは、<strong>3枚のどれを引いても価値がほぼ変わらない</strong>ことを意味します。特定の1枚を狙う理由が薄く、開封する側から見れば「当たり枠を引けば当たり」という分かりやすさがあります。一方で、ルフィのような突出した1枚がないため、弾全体の相場を強く牽引する存在も不在です。</div>

<h2>発見②｜販売価格では順位が入れ替わる</h2>
<p>8月下旬まで買取はサカズキとクザンが同額(各23万円)でしたが、9月1日時点では<strong>サカズキ17万円が単独トップ</strong>となり、クザンとボルサリーノが15万円で並んでいます。販売価格でもサカズキが約24.8万円で最高値、クザンとボルサリーノは約21.8万円です。</p>

<p>買取価格が同額でも販売価格に差が出るのは、<strong>店側の在庫状況や回転の見込みが反映される</strong>ためと考えられます。買取は「仕入れたい額」、販売は「売れると見込む額」で、必ずしも連動しません。</p>

<div class="callout"><strong>売買での注意:</strong> 「販売価格が高い＝買取も高い」とは限りません。<strong>売るときは買取価格、買うときは販売価格</strong>を、それぞれ複数店で比較してください。この3枚のように、ソースや店によって序列が変わるケースでは特に重要です。</div>

<h2>封入率とBOX代換算</h2>
<p>OP-16のスーパーパラレルの封入率は、トレカ系メディアの推定値で<strong>約0.99%(約100.7BOXに1枚)</strong>とされています。海軍大将トリオは3種あるため、<strong>狙いの1枚は約0.33%、約302BOXに1枚</strong>という計算です。</p>

<table class="price-table">
<thead><tr><th>狙い方</th><th style="text-align:right">必要BOX数の目安</th><th style="text-align:right">BOX代(定価¥5,280換算)</th></tr></thead>
<tbody>
<tr><td>大将トリオのどれか1枚</td><td class="price">約100.7BOX</td><td class="price">約¥532,000</td></tr>
<tr class="best"><td><strong>狙いの1枚を指名</strong></td><td class="price"><strong>約302BOX</strong></td><td class="price"><strong>約¥1,595,000</strong></td></tr>
</tbody>
</table>

<p>狙い撃ちのBOX代は約159.5万円で、カードの買取17万円を大きく上回ります。<strong>指名買いなら、開封せずカードを直接買うほうが圧倒的に安い</strong>という、高額パラレルの一般的な結論どおりです。</p>

<p>ただし前述のとおり<strong>3枚の価値がほぼ同じ</strong>なので、「どれでもいいから大将のスーパーパラレルが欲しい」という場合は約100.7BOX(約53.2万円)が目安になります。それでも買取17万円との差は大きく、開封が有利になるわけではありません。</p>

<div class="callout"><strong>例外はルフィ金だけ:</strong> 当サイトが確認した範囲で、BOX代換算をカード価格が上回るのは<a href="anniversary-sp-guide.html">3周年スペシャルのルフィ金</a>のみです。海軍大将トリオを含め、他はすべて自引きが不利になります。</div>

<h2>日本版初のトレジャーレア(TR)</h2>
<p>OP-16には、もうひとつ注目点があります。<strong>日本版で初めて「トレジャーレア(TR)」が収録された弾</strong>だという点です。</p>

<p>第1弾のTRは<strong>「インペルダウンの囚人」</strong>で、封入率は<strong>約1.32%(約75.5BOXに1枚)</strong>と推定されています。TRは1種のみのため、この確率がそのまま自引き確率になります。相場は買取約2,230円・販売約3,980円で、封入率のわりに高額ではありません。</p>

<div class="callout"><strong>封入率と相場は必ずしも比例しない:</strong> TRはスーパーパラレル(約100.7BOXに1枚)より出やすい約75.5BOXに1枚ですが、相場は約100分の1です。<strong>レアリティの新しさや珍しさが、そのまま価格になるとは限らない</strong>という良い例で、新レアリティ登場時の値付けを考えるときの参考になります。</div>

<h2>売買の注意点</h2>
<ul>
<li><strong>3枚の価値はほぼ同じ</strong> — 買取で最大1.15倍差です。「サカズキだから高い」といった前提で値付けされた出品には注意してください。</li>
<li><strong>販売価格の序列とは違う</strong> — 販売ではクザンが最高値ですが、買取は同額です。売るときは買取価格で比較してください。</li>
<li><strong>ソースによる差がある</strong> — 本記事はaltema基準ですが、別ソースでは3枚を約21.3万・21.3万・19.3万としています。売却時は複数店の実額を確認してください。</li>
<li><strong>BOX相場は下落局面にある</strong> — OP-16は2026年5月発売の比較的新しい弾で、当サイトの実データでもBOX買取が下落幅の上位に入っています(<a href="box-price-pattern.html">BOX相場の値動きパターン</a>参照)。BOXで持つ場合は供給状況に注意が必要です。</li>
<li><strong>状態が査定に直結する</strong> — 15万円台の価格帯でも、センタリングや白かけの影響が大きくなります。鑑定の判断は<a href="psa-guide.html">PSA鑑定ガイド</a>を参照してください。</li>
</ul>""",
        "faq": [
            {"q": "海軍大将トリオのコミパラはいくらで売れますか？",
             "a": "2026年9月1日時点の買取で、サカズキ約23万円、クザン約23万円、ボルサリーノ約20万円です(altema掲載のカードラッシュ買取価格基準)。別ソースでは約21.3万・21.3万・19.3万としており、どのソースでも「サカズキとクザンが同額、ボルサリーノがやや下」という並びは一致しています。"},
            {"q": "3枚の中でどれが一番高いですか？",
             "a": "買取ではサカズキとクザンが同額で並び、ボルサリーノがやや下です。最大でも1.15倍差の横並びで、どれを引いても価値はほぼ変わりません。ただし販売価格ではクザンが約36.3万円で最高値になり、買取とは序列が異なります。売るときは買取価格、買うときは販売価格で比較してください。"},
            {"q": "なぜレッドコミパラのように大きな差がつかないのですか？",
             "a": "グループに主人公が含まれていないためと考えられます。レッドコミパラ(3.8倍差)も3周年スペシャル(7.8倍差)も最高額はモンキー・D・ルフィで、主人公補正が突出した1枚を作っていました。海軍大将トリオは3人とも同格の立場で人気も拮抗しているため、相場が横並びになっています。"},
            {"q": "BOXを買って狙うのは得ですか？",
             "a": "得ではありません。狙いの1枚は約302BOX(BOX代換算で約159.5万円)に1枚とされ、カードの買取23万円を大きく上回ります。3枚どれでもよい場合は約100.7BOX(約53.2万円)が目安ですが、それでも買取額との差は大きく、開封が有利にはなりません。当サイトが確認した範囲でBOX代を上回るのは3周年スペシャルのルフィ金のみです。"},
            {"q": "トレジャーレア(TR)とは何ですか？",
             "a": "OP-16で日本版に初めて導入されたレアリティです。第1弾のTRは「インペルダウンの囚人」で、封入率は約1.32%(約75.5BOXに1枚)と推定されています。スーパーパラレル(約100.7BOXに1枚)より出やすい一方、相場は買取約2,230円と大きな差があります。レアリティの新しさが必ずしも価格に直結しない例です。"},
        ],
    },
    {
        "slug": "restock-guide",
        "nav_label": "再販・入荷ガイド",
        "crumb": "ワンピカード 再販・入荷ガイド",
        "date": "2026-08-25",
        "date_jp": "2026年8月25日",
        "title": "ワンピースカードの再販・入荷ガイド｜絶版制度がない仕組みと、再販が相場に効く弾・効かない弾",
        "h1": "ワンピースカードの再販・入荷ガイド｜「絶版」制度がない仕組みと、再販が相場に効く弾・効かない弾",
        "meta_desc": "ワンピースカードの再販・入荷を体系的に整理。ONE PIECEカードゲームには絶版・生産終了の公式アナウンス制度がなく、バンダイは増産と再販を継続しています。2026年に確認できた再販の実績、駿河屋やコンビニなどチャネル別の入手経路、店舗入荷が抽選である仕組み、そして当サイトのBOX買取実データから見えた「再販が相場に効く弾・効かない弾」の違いまで解説します。",
        "og_title": "ワンピカードの再販・入荷ガイド｜絶版制度がない仕組みと相場への影響",
        "og_desc": "ワンピカードに絶版制度がない理由、2026年の再販実績、チャネル別の入手経路、店舗入荷が抽選である仕組み、再販が相場に効く弾・効かない弾をBOX実データで解説。",
        "meta_line": "再販の仕組み・入手経路・相場への影響",
        "hero_label": "ワンピースカード 再販・入荷ガイド",
        "hero_big": "「絶版」の公式制度はない",
        "hero_sub": "ONE PIECEカードゲームには絶版・生産終了を公式にアナウンスする制度がなく、バンダイは増産・再販を継続しています。ただし再販の告知は網羅的ではなく、店舗への入荷も抽選です。仕組みと入手経路、そして再販がBOX相場に与える影響を当サイトの実データで整理します。",
        "disclaimer": "本記事の再販情報は<strong>2026年8月時点</strong>で確認できた公開情報に基づく参考情報です。バンダイは個別弾の再販・追加出荷を網羅的に公表していないため、<strong>掲載している実績は確認できた一部にすぎず、これ以外の再販が行われていないことを意味しません</strong>。入荷の曜日・時間帯は店舗や配送ルートにより異なり、記載はあくまで傾向です。店舗への入荷は抽選制とされており、発注しても入荷しない場合があります。将来の再販の有無・時期を予測するものではありません。BOX買取価格は当サイトが最大10店舗から自動取得した実データで、日々変動します。購入・売却の判断はご自身の責任で行ってください。",
        "related": '<li><a href="/onepiece">ワンピBOX買取価格比較トップ</a> — 全弾のBOX買取価格を最大10店舗で横断比較(毎日更新)</li>\n'
                   '<li><a href="box-price-pattern.html">BOX相場の値動きパターン</a> — 新しい弾ほど下がる傾向を実データで検証</li>\n'
                   '<li><a href="kougaku-ranking.html">高額BOXランキング・絶版ガイド</a> — 全弾の最高買取・定価比とブロックアイコン制度</li>\n'
                   '<li><a href="toushi.html">ワンピカードBOX投資の始め方</a> — 値上がりしやすいBOXの特徴と保管・リスク</li>\n'
                   '<li><a href="kaitori-hikaku.html">ワンピBOX買取比較ガイド</a> — 売るときの店舗選びと高く売るコツ</li>\n'
                   '<li><a href="weekly.html">週間値動きランキング</a> — 直近7日間の値上がり・値下がりを毎日自動更新</li>',
        "body": """<p>「このBOXはもう手に入らないのか」「待っていれば再販されるのか」——ワンピースカードを買うときも売るときも、判断の前提になるのが<strong>再販がどう行われているか</strong>です。</p>

<p>本記事では、<strong>再販の仕組み・実際の入手経路・相場への影響</strong>を整理します。相場への影響については、当サイトが最大10店舗から毎日自動取得しているBOX買取の実データを使って検証します。</p>

<div class="callout"><strong>3行まとめ:</strong><br>
・ワンピースカードには<strong>「絶版」「生産終了」を公式にアナウンスする制度がない</strong>。バンダイは増産・再販を継続している<br>
・ただし<strong>再販の告知は網羅的ではなく</strong>、店舗への入荷も<strong>抽選</strong>。「いつ・どこに来るか」は事前に確定しない<br>
・当サイトの実データでは、<strong>再販の影響が出やすいのは新しい弾</strong>。古い弾は再販が新弾に集中するぶん相場が下支えされる</div>

<h2>ワンピースカードに「絶版」はあるのか</h2>
<p>結論から言うと、<strong>ONE PIECEカードゲームには絶版・生産終了を公式にアナウンスする制度がありません</strong>。ポケモンカードのようにレギュレーション変更が事実上の絶版と結びつく図式も、ワンピースカードでは成立しません。</p>

<p>バンダイは増産・再販を継続しており、新弾は発売1か月前後で追加生産される例が多く見られます。旧弾についても、後述のとおり2026年に入ってから複数回の再販が確認できています。</p>

<div class="callout"><strong>では、なぜ旧弾のBOXは高いのか:</strong> 「絶版だから」ではありません。<strong>(1)開封が進んで未開封在庫が自然に減る (2)再販が新弾に集中する (3)看板カードの相場が下支えする</strong>——この3点の複合と考えるのが実態に近いところです。当サイトの<a href="kougaku-ranking.html">高額BOXランキング</a>で古い弾が上位を占めるのも、この構造によるものです。</div>

<h3>ブロックアイコン制度との関係</h3>
<p>2026年4月1日に導入された<strong>ブロックアイコン制度</strong>(カード右下の数字で競技での使用可否を区切る仕組み)により、ブロック①のOP-01〜OP-04とST-01〜ST-09はスタンダードで使用できなくなりました。</p>

<p>ただしこれは<strong>競技での使用可否の話であって、生産や流通の終了を意味しません</strong>。実際、当サイトのBOX買取実データでは、スタンダード使用不可になった<a href="op-01-atari-guide.html">OP-01(ROMANCE DAWN)</a>が全弾でも上位の買取価格を維持し続けています。<strong>スタン落ち＝BOX暴落ではない</strong>ことは、実データがはっきり示しています。</p>

<h2>2026年に確認できた再販の実績</h2>
<p>バンダイは個別弾の再販を網羅的に公表していないため、以下は<strong>公開情報から確認できた一部</strong>です。これ以外の再販が行われていないことを意味するものではありません。</p>

<table class="price-table">
<thead><tr><th>時期</th><th>対象弾</th><th>チャネル</th></tr></thead>
<tbody>
<tr><td>2026年4月中旬</td><td><a href="op-15-atari-guide.html">神の島の冒険(OP-15)</a></td><td>販売店から追加出荷の案内</td></tr>
<tr><td>2026年4月28日</td><td><a href="op-13-atari-guide.html">受け継がれる意志(OP-13)</a> / <a href="op-15-atari-guide.html">神の島の冒険(OP-15)</a> / <a href="op-14-atari-guide.html">蒼海の七傑(OP-14)</a></td><td>一部のローソン</td></tr>
<tr><td>2026年6月27日</td><td><a href="op-13-atari-guide.html">受け継がれる意志(OP-13)</a> / <a href="eb-04-atari-guide.html">EGGHEAD CRISIS(EB-04)</a></td><td>一部のローソン</td></tr>
<tr><td>継続的</td><td>OP-10 / OP-13 / OP-14 / OP-15 ほか</td><td>駿河屋・Amazon・楽天ブックス・セブンネット・Yahoo!ショッピング等</td></tr>
</tbody>
</table>

<p>傾向として、<strong>再販の対象になりやすいのは発売から比較的日が浅い弾</strong>です。上の実績でもOP-13〜OP-15が繰り返し登場しています。</p>

<h2>どこで買えるか｜チャネル別の特徴</h2>
<h3>オンラインストア</h3>
<p>Amazon・楽天ブックス・セブンネットショッピング・Yahoo!ショッピングなどで、定価での再販が断続的に行われています。ただし<strong>販売開始とほぼ同時に完売する状況が続いており</strong>、先着で買うのは容易ではありません。</p>

<h3>中古・専門ストア</h3>
<p>駿河屋などの中古・専門ストアでは、旧弾の再販入荷が比較的頻繁に記録されています。定価より高い場合もありますが、<strong>在庫が出る頻度は高い</strong>チャネルです。</p>

<h3>コンビニ</h3>
<p>ローソンを中心に、コンビニでの再販も実施されています。入荷の傾向として次のような情報が共有されていますが、<strong>店舗や配送ルートによって異なるため、あくまで目安</strong>として捉えてください。</p>
<ul>
<li><strong>ローソン</strong>: 新商品の入荷は火曜が多く、トレーディングカードの販売開始は全店共通で午前7時とされています。</li>
<li><strong>ファミリーマート</strong>: 月曜から火曜にかけての入荷が多いとされています。</li>
<li><strong>セブンイレブン</strong>: 店舗によっては電話での取り置きに応じてもらえたという報告があります。</li>
</ul>

<div class="callout"><strong>重要な仕組み — 店舗入荷は抽選:</strong> コンビニで「一部店舗のみ」の入荷になるのは、<strong>店舗が発注しても必ず入荷するわけではなく、抽選で当選した店舗にのみ配分される</strong>ためとされています。近所の店に来なかったからといって再販がなかったわけではなく、<strong>店舗単位で当たり外れがある</strong>と理解しておくと空振りが減ります。</div>

<h2>再販は相場にどう効くか｜実データで検証</h2>
<p>ここからは当サイトのBOX買取実データを使います。<a href="box-price-pattern.html">BOX相場の値動きパターン</a>で全弾の値動きを集計したところ、明確な傾向が出ました。</p>

<ul>
<li><strong>下落は発売から日の浅い弾に集中している</strong> — 追加出荷や再販がかかりやすく、市場の未開封在庫が増えるためと考えられます。</li>
<li><strong>古い弾は横ばいか上昇で安定している</strong> — 再販が新弾に集中するぶん供給が絞られ、相場が下支えされます。</li>
</ul>

<p>つまり、<strong>再販が相場に効くのは主に新しい弾</strong>です。古い弾については、再販そのものよりも「開封で未開封BOXが減っていく」効果のほうが大きく出ています。</p>

<p>現在のBOX買取価格の全弾ランキングは以下のとおりです(毎日自動更新)。</p>

{{BOX_RANKING}}

<div class="callout"><strong>注意 — 因果は断定できません:</strong> バンダイが個別弾の再販を網羅的に公表していない以上、「この弾が下がったのは再販のせい」と特定することはできません。上記はあくまで<strong>値動きの傾向と、BOX相場の一般的な構造を突き合わせた整理</strong>です。</div>

<h2>待つべきか、今買うべきか</h2>
<h3>プレイ目的・開封目的なら</h3>
<p>再販は継続しているため、<strong>プレ値で焦って買う必要は薄い</strong>と言えます。特に新しい弾は追加出荷がかかりやすく、時間の経過とともに入手性が改善する傾向があります。オンラインの先着販売や、コンビニの入荷タイミングを狙う余地があります。</p>

<h3>コレクション・保有目的なら</h3>
<p>古い弾ほど供給が絞られており、<strong>待っても安くなりにくい</strong>のが実データから見える傾向です。ただし<a href="toushi.html">BOX投資</a>は値上がりを保証するものではなく、下落もあり得る現物取引です。参入コストは<a href="kougaku-ranking.html">高額BOXランキング</a>の定価比で確認してください。</p>

<h3>売却を考えているなら</h3>
<p>再販や新弾発売は相場が動くきっかけになります。売る直前に<a href="/onepiece">比較トップ</a>で最高値の店を確認し、<a href="weekly.html">週間値動きランキング</a>で直近の方向感もあわせて見ることをおすすめします。</p>

<h2>注意点</h2>
<ul>
<li><strong>再販情報は変動が激しい</strong> — 本記事の実績は2026年8月時点で確認できた範囲です。最新の入荷情報は各店舗・各ストアの告知を確認してください。</li>
<li><strong>「再販未定」は「もう出ない」ではない</strong> — 公式のアナウンス制度がないため、告知がないことと再販がないことは別です。</li>
<li><strong>入荷の曜日・時間は目安</strong> — 店舗や配送ルートで異なります。確実に買いたい場合は店舗に直接確認するのが早道です。</li>
<li><strong>転売価格との比較を忘れずに</strong> — 定価で買えるチャネルがある以上、プレ値で買う前に他の入手経路を一通り確認する価値があります。</li>
</ul>""",
        "faq": [
            {"q": "ワンピースカードに「絶版」はありますか？",
             "a": "公式に絶版・生産終了をアナウンスする制度はありません。バンダイは増産・再販を継続しており、新弾は発売1か月前後で追加生産される例が多く、旧弾も2026年に複数回の再販が確認できています。旧弾のBOXが高いのは絶版だからではなく、開封で未開封在庫が減ること・再販が新弾に集中すること・看板カードの相場が下支えすることの複合と考えるのが実態に近いです。"},
            {"q": "スタンダードで使えなくなった弾は生産終了ですか？",
             "a": "違います。2026年4月1日導入のブロックアイコン制度でブロック①(OP-01〜OP-04、ST-01〜ST-09)がスタンダード使用不可になりましたが、これは競技での使用可否の話で、生産や流通の終了を意味しません。実際、当サイトのBOX買取実データではスタン落ち後のOP-01が全弾でも上位の買取価格を維持しています。"},
            {"q": "再販はどこで行われますか？",
             "a": "Amazon・楽天ブックス・セブンネットショッピング・Yahoo!ショッピングなどのオンラインストア、駿河屋などの中古・専門ストア、そしてローソンを中心としたコンビニで確認されています。オンラインの先着販売は販売開始とほぼ同時に完売する状況が続いています。"},
            {"q": "コンビニの入荷はいつですか？",
    ...
    },
    {
        ...
        "date": "2026-09-01",
        "date_jp": "2026年9月1日",
        "title": "EB-02 ルフィ コミパラ徹底解説｜7月の65万から35万へ、1か月半で-46%の急落と「定価換算プラス」が消えた理由",
        "h1": "モンキー・D・ルフィ コミパラ(EB-02)徹底解説｜買取35万円への急落と、定価換算プラスが1週間で消えた理由",
        "meta_desc": "Anime 25th collection(EB-02)のモンキー・D・ルフィ コミックパラレルを単体で徹底解説。2026年9月1日時点で買取35万円・販売49.8万円・PSA10相場64.1万円、鑑定1,920枚・取得率90.8%。7月のピーク65万円から1か月半で-46%下落し、8月下旬まで成立していた「定価換算ならBOXを買って自引きするほうが得」という関係が消えた過程を実データで追いました。あわせて以前の版で誤って記していた「コミパラが1種しかない唯一の弾」という記述を訂正しています。",
        "og_title": "EB-02 ルフィ コミパラ｜65万→35万の急落と定価換算プラスの消滅",
        "og_desc": "買取35万・PSA10相場64.1万。7月のピークから-46%。8月下旬まで成立していた定価換算プラスが1週間で消えた過程を実データで解説。",
        "meta_line": "EB-02ルフィ コミパラの相場・急落の推移・封入率・PSA10・定価換算",
        "hero_label": "モンキー・D・ルフィ コミックパラレル【EB-02】",
        "hero_big": "買取 約¥350,000",
        "hero_sub": "Anime 25th collection(EB-02)収録。2026年7月のピーク<strong>65万円から-46%</strong>の水準で、<strong>コミックパラレルが1種類だけの弾では最高額</strong>です。販売49.8万円/PSA10相場64.1万円。相場・鑑定データは2026年9月1日時点。",
        "disclaimer": "本記事のカード相場は<strong>2026年9月1日時点</strong>にカード相場メディア altema が掲載する<strong>カードラッシュの買取・販売価格</strong>、およびPSA10相場(2026年8月30日更新)を基準にした目安です。1店舗の価格を基準にしているため、他店の買取額や実際の取引価格とは異なります。封入率は公式発表ではなく開封報告等に基づく推定値です。<strong>本記事のBOX代換算は定価(¥5,280)で計算した机上の数字</strong>で、実際にはEB-02のBOXが定価で流通していないため、そのまま実行できる話ではありません(本文で詳述します)。BOX買取価格は当サイトが最大9店舗から自動取得した実データです。売買・開封の判断はご自身の責任で行ってください。",
        "related": "<li><a href=\"eb-02-atari-guide.html\">Anime 25th collection(EB-02) 当たりカードガイド</a> — 収録弾の当たり全体と封入率</li>\n<li><a href=\"box/eb-02.html\">Anime 25th collection(EB-02) BOX買取価格</a> — 店舗別のBOX買取価格を毎日更新</li>\n<li><a href=\"comipara-ranking.html\">歴代コミックパラレル相場ランキング全22弾</a> — 全弾のコミパラ相場ランキング</li>\n<li><a href=\"nika-luffy-comipara.html\">ニカルフィ コミパラ(OP05-119)徹底解説</a> — コミパラ最高峰の相場と封入率</li>\n<li><a href=\"psa-guide.html\">ワンピースカードのPSA鑑定ガイド</a> — 鑑定に出すべきかの判断基準</li>\n<li><a href=\"/onepiece\">ワンピBOX買取価格比較トップ</a> — 全弾のBOX買取価格を最大10店舗で横断比較</li>",
        "body": """<p><strong>モンキー・D・ルフィ コミックパラレル(EB02-061)</strong>は、<a href="eb-02-atari-guide.html">Anime 25th collection(EB-02)</a>に収録された本弾の看板カードです。アニメ25周年を記念したエクストラブースターの目玉で、2026年9月1日時点の買取相場は<strong>約35万円</strong>。7月のピーク65万円からは<strong>-46%</strong>という大きな調整局面にあります。</p>

<div class="callout"><strong>3行まとめ:</strong><br>
・買取<strong>約35万円</strong>／販売約49.8万円／PSA10相場<strong>約64.1万円</strong>(2026年9月1日時点)<br>
・<strong>7月65万円 → 8月25日50万円 → 9月1日35万円</strong>と、直近1週間だけで-30%<br>
・8月下旬まで成立していた<strong>「定価換算ならBOXを買って自引きするほうが得」という関係が消滅</strong>した</div>

<div class="callout" style="border-left-color:#b91c1c"><strong>訂正(2026年9月1日):</strong> 本記事は以前、EB-02を「コミックパラレルが全1種類しか存在しない唯一の弾」と記載していましたが、これは誤りでした。当サイトが全弾の封入率を確認したところ、<strong>コミパラが1種類だけの弾は23弾中18弾</strong>あり、むしろ多数派です。正しくは<strong>「コミパラが1種類の弾のなかで最高額」</strong>となります。お詫びして訂正します(詳細は後述)。</div>
...
<tbody>
<tr><td>カード名</td><td>モンキー・D・ルフィ</td></tr>
<tr><td>型番</td><td>EB02-061</td></tr>
<tr><td>レアリティ</td><td>コミックパラレル</td></tr>
...
<thead><tr><th>区分</th><th style="text-align:right">金額</th><th>備考</th></tr></thead>
<tbody>
<tr class="best"><td><strong>買取価格</strong></td><td class="price"><strong>約¥350,000</strong></td><td>素体(未鑑定)</td></tr>
<tr><td>販売価格</td><td class="price">約¥498,000</td><td>素体(未鑑定)</td></tr>
<tr><td>PSA10相場</td><td class="price">約¥641,000</td><td>鑑定済み(2026年8月30日更新)</td></tr>
</tbody>
</table>

<p>素体買取35万円に対しPSA10が64.1万円で、<strong>鑑定による上乗せは約1.8倍</strong>です。素体が大きく下げた一方でPSA10の下げ幅は相対的に小さく、8月下旬の時点(素体50万円・PSA10 70万円＝約1.4倍)より差が広がりました。</p>
...
<h2>発見1｜1か月半で-46%、直近1週間で-30%</h2>
<p>本カードの相場は2026年に入ってから急上昇し、7月にピークを打ったあと、8月後半から一気に調整しました。買取価格の推移は次のとおりです。</p>

<table class="price-table">
<thead><tr><th>時点</th><th style="text-align:right">買取</th><th style="text-align:right">PSA10</th></tr></thead>
<tbody>
<tr><td>2025年11月</td><td class="price">¥85,000</td><td class="price">¥158,000</td></tr>
<tr><td>2026年1月</td><td class="price">¥180,000</td><td class="price">¥298,000</td></tr>
<tr><td>2026年3月</td><td class="price">¥170,000</td><td class="price">¥284,000</td></tr>
<tr><td>2026年5月</td><td class="price">¥350,000</td><td class="price">¥657,000</td></tr>
<tr class="best"><td><strong>2026年7月(ピーク)</strong></td><td class="price"><strong>¥650,000</strong></td><td class="price">¥1,020,000</td></tr>
<tr><td>2026年8月5日</td><td class="price">¥600,000</td><td class="price">¥928,000</td></tr>
<tr><td>2026年8月25日</td><td class="price">¥500,000</td><td class="price">¥700,000</td></tr>
<tr class="best"><td><strong>2026年9月1日</strong></td><td class="price"><strong>¥350,000</strong></td><td class="price">¥641,000</td></tr>
</tbody>
</table>

<p>ピークからの下落率は<strong>-46%</strong>、直近1週間(8月25日→9月1日)だけでも<strong>-30%</strong>です。ワンピースカードの高額帯は数日単位で数万円〜十数万円動くため変動自体は珍しくありませんが、<strong>1週間で3割という下げ幅は、売り時の判断を一週間ずらすだけで結果が大きく変わる</strong>ことを示しています。</p>
<div class="callout"><strong>この下落は本カード固有か:</strong> いいえ。当サイトが同時点で確認した全弾のカード相場では、<a href="op-05-atari-guide.html">OP-05ニカルフィ</a>が80万→65万、<a href="op-09-atari-guide.html">OP-09ロジャー金</a>が70万→55万、<a href="op-16-atari-guide.html">OP-16サカズキ</a>が23万→17万と、<strong>高額帯が横並びで下げています</strong>。EB-02だけの現象ではなく、相場全体の調整局面と見るのが妥当です。</div>

<h2>発見2｜「コミパラ1種の弾」は唯一ではなく多数派だった(訂正)</h2>
<p>本記事は以前、EB-02を「コミックパラレルが全1種類しか存在しない唯一の弾」と説明していました。<strong>これは誤りです。</strong></p>
<p>全弾の封入率表を確認したところ、コミパラが複数種収録されているのは<strong>OP-05(3種+サイン)・OP-09(5種)・OP-13(3種+レッド3種)・OP-16(3種)・OP-17(4種)の5弾のみ</strong>で、残る<strong>18弾はいずれもコミパラが1種類</strong>でした。つまり「1種類」は例外ではなく標準仕様です。</p>

<table class="price-table">
<thead><tr><th>コミパラ1種の弾</th><th>カード</th><th style="text-align:right">買取</th></tr></thead>
<tbody>
<tr class="best"><td><strong>EB-02</strong></td><td><strong>モンキー・D・ルフィ</strong></td><td class="price"><strong>¥350,000</strong></td></tr>
<tr><td><a href="eb-01-atari-guide.html">EB-01</a></td><td>トニートニー・チョッパー</td><td class="price">¥200,000</td></tr>
<tr><td><a href="op-06-atari-guide.html">OP-06</a></td><td>ロロノア・ゾロ</td><td class="price">¥200,000</td></tr>
<tr><td><a href="op-07-atari-guide.html">OP-07</a></td><td>ボア・ハンコック</td><td class="price">¥140,000</td></tr>
<tr><td><a href="op-01-atari-guide.html">OP-01</a></td><td>シャンクス</td><td class="price">¥130,000</td></tr>
<tr><td><a href="op-11-atari-guide.html">OP-11</a></td><td>モンキー・D・ルフィ</td><td class="price">¥120,000</td></tr>
<tr><td><a href="op-02-atari-guide.html">OP-02</a></td><td>ポートガス・D・エース</td><td class="price">¥120,000</td></tr>
</tbody>
</table>

<p>この並びが示すのは、<strong>EB-02のルフィは「コミパラが1種類の弾」のなかで最高額</strong>だということです。2位グループ(EB-01チョッパー・OP-06ゾロ)の20万円に対して1.75倍で、単独の1枚に価値が集中しています。</p>
<div class="callout"><strong>1種であることの意味は変わらない:</strong> 訂正したのは「唯一かどうか」だけで、<strong>「コミパラ枠を引けば必ずそのカードになる」という性質自体は正しい</strong>です。<a href="op-13-atari-guide.html">OP-13</a>のレッドコミパラは3種、<a href="op-09-atari-guide.html">OP-09</a>は5種あるため、狙いの1枚を引く確率は種類数で割った値まで下がります。EB-02にはその割り算が発生しません。</div>

<h2>発見3｜「定価換算プラス」は1週間で消えた</h2>
<p>本記事が以前の版で最大の特徴として挙げていたのが、<strong>定価換算ではBOX代よりカードのほうが高い</strong>という関係でした。コミパラの封入率は6カートン(約72BOX)に約1枚とされ、BOX定価¥5,280で換算すると必要BOX代は<strong>約38万円</strong>。8月26日時点のカード買取50万円はこれを上回っていました。</p>
<p><strong>この関係は9月1日時点で消滅しています。</strong></p>

<table class="price-table">
<thead><tr><th>時点</th><th style="text-align:right">必要BOX代(定価換算)</th><th style="text-align:right">カード買取</th><th style="text-align:right">差</th></tr></thead>
<tbody>
<tr><td>2026年8月26日</td><td class="price">約¥380,000</td><td class="price">¥500,000</td><td class="price" style="color:#15803d;font-weight:700">+約12万円</td></tr>
<tr class="best"><td><strong>2026年9月1日</strong></td><td class="price">約¥380,000</td><td class="price"><strong>¥350,000</strong></td><td class="price" style="color:#b91c1c;font-weight:700">-約3万円</td></tr>
</tbody>
</table>

<p>BOX定価は動かないので、<strong>カード側が下がっただけで符号が反転</strong>しました。他の高額コミパラと並べると、EB-02は依然として最もマイナス幅が小さいものの、もはや「プラス」ではありません。</p>
...
<tbody>
<tr class="best"><td><strong>ルフィ コミパラ(EB-02)</strong></td><td class="price">約72BOX</td><td class="price">約¥380,000</td><td class="price"><strong>¥350,000</strong></td><td class="price" style="color:#b91c1c;font-weight:700">-約3万円</td></tr>
<tr><td><a href="eb-01-atari-guide.html">チョッパー(EB-01)</a></td><td class="price">約72BOX</td><td class="price">約¥380,000</td><td class="price">¥200,000</td><td class="price" style="color:#b91c1c;font-weight:700">-約18万円</td></tr>
<tr><td><a href="nika-luffy-comipara.html">ニカルフィ(OP-05)</a></td><td class="price">約288BOX</td><td class="price">約¥1,521,000</td><td class="price">¥650,000</td><td class="price" style="color:#b91c1c;font-weight:700">-約87万円</td></tr>
<tr><td><a href="roger-gold-comipara.html">ロジャー金(OP-09)</a></td><td class="price">約360BOX</td><td class="price">約¥1,901,000</td><td class="price">¥550,000</td><td class="price" style="color:#b91c1c;font-weight:700">-約135万円</td></tr>
<tr><td><a href="red-comipara-guide.html">ルフィ赤(OP-13)</a></td><td class="price">約631BOX</td><td class="price">約¥3,332,000</td><td class="price">¥1,800,000</td><td class="price" style="color:#b91c1c;font-weight:700">-約153万円</td></tr>
</tbody>
</table>

<div class="callout"><strong>そもそも定価では買えない:</strong> この計算にはBOXを定価¥5,280で買えるという前提があります。当サイトの実データでは<strong>EB-02のBOX買取価格は{{EB02_PRICE}}({{EB02_MULT}})</strong>で、購入価格はさらに上です。市場価格で72BOX集めれば軽く200万円を超えるため、<strong>プラスだった時期であっても実行できる話ではありませんでした</strong>。この計算が実務的に意味を持つのは、発売直後に定価で確保できる新弾の場合だけです。</div>

<h2>発見4｜弾の価値がこの1枚に集中している</h2>
<p>EB-02の当たりカード上位を見ると、価格差の構造が分かります。</p>

<table class="price-table">
<thead><tr><th>順位</th><th>カード</th><th style="text-align:right">買取価格</th></tr></thead>
<tbody>
<tr class="best"><td>1位</td><td><strong>モンキー・D・ルフィ コミパラ</strong></td><td class="price"><strong>¥350,000</strong></td></tr>
<tr><td>2位</td><td>モンキー・D・ルフィ スペシャルカード</td><td class="price">¥200,000</td></tr>
<tr><td>3位</td><td>ボア・ハンコック スペシャルカード</td><td class="price">¥130,000</td></tr>
<tr><td>4位</td><td>トニートニー・チョッパー スペシャルカード</td><td class="price">¥100,000</td></tr>
<tr><td>5位</td><td>モンキー・D・ルフィ リーダーパラレル</td><td class="price">¥75,000</td></tr>
<tr><td>6位</td><td>ヴィンスモーク・レイジュ スペシャルカード</td><td class="price">¥45,000</td></tr>
</tbody>
</table>

<p>上位6枚のうち<strong>3枚がルフィ</strong>で、1位と2位の差は1.75倍にとどまります。<a href="comipara-ranking.html">他弾では1位が2位を3〜9倍引き離すケースが多い</a>のに対し、EB-02は<strong>上位が比較的なだらか</strong>です。アニメ25周年という記念弾の性格上、スペシャルカードが26種と多く、人気キャラの枠が厚く用意されていることが影響していると考えられます。</p>

<h2>売買の注意点</h2>
<ul>
<li><strong>下落局面にある</strong> — 直近1週間で-30%です。売却を考えているなら、店舗ごとの提示額の差より先に、最新の相場水準を確認してください。</li>
<li><strong>コミパラは1種のみ</strong> — 「EB-02のコミパラ」と言えばこのルフィです。種類を確認する必要はありません。</li>
<li><strong>ルフィのスペシャルカードと混同しない</strong> — 同じ弾にルフィのSP(買取約20万円)があります。コミパラは背景が漫画のコマになっているのが目印です。</li>
<li><strong>PSA10は狙いやすい</strong> — 取得率90.8%と高水準です。素体35万円に対しPSA10が64.1万円(約1.8倍)なので、鑑定料と期間を踏まえて判断してください(詳細は<a href="psa-guide.html">PSA鑑定ガイド</a>)。</li>
<li><strong>定価換算の数字を鵜呑みにしない</strong> — BOX代38万円という計算は定価前提で、現在のBOX相場では成立しません。</li>
</ul>""",
        "faq": [
            {"q": "EB-02のルフィ コミパラはいくらで売れますか？",
             "a": "2026年9月1日時点で買取約35万円、販売約49.8万円、PSA10相場は約64.1万円です(altema掲載のカードラッシュ価格基準)。7月のピーク65万円からは-46%、直近1週間(8月25日の50万円)からも-30%と下落局面にあります。素体からPSA10への上乗せは約1.8倍で、PSA10取得率は90.8%と高水準です。"},
            {"q": "EB-02のコミパラは何種類ありますか？",
             "a": "全1種類で、このモンキー・D・ルフィのみです。ただし本記事は以前これを「1種類しかない唯一の弾」と記載していましたが誤りで、コミパラが1種類の弾は23弾中18弾あり多数派です。複数種収録なのはOP-05・OP-09・OP-13・OP-16・OP-17の5弾のみになります。正しくはEB-02のルフィは「コミパラが1種類の弾のなかで最高額」で、2位のEB-01チョッパー・OP-06ゾロ(各20万円)の1.75倍です。"},
            {"q": "BOXを買って狙うのは得ですか？",
             "a": "2026年9月1日時点では損になります。約72BOXに1枚とされ、定価¥5,280で換算すると必要BOX代は約38万円。これに対しカード買取は35万円で、約3万円のマイナスです。8月26日時点(カード50万円)では+12万円のプラスでしたが、カード側の下落で反転しました。さらに現実にはEB-02のBOXが定価で流通していないため、市場価格で72BOX集めると200万円を大きく超えます。"},
            {"q": "なぜ1週間で30%も下がったのですか？",
             "a": "EB-02固有の事情ではなく、高額帯が横並びで調整しているためと見られます。同じ9月1日時点で、OP-05ニカルフィが80万→65万、OP-09ロジャー金が70万→55万、OP-16サカズキが23万→17万と、当サイトが確認した全弾のトップレアがそろって下げています。一方でBOX買取価格は同じ動きをしておらず、カード相場とBOX相場は連動しません。"},
            {"q": "ルフィのスペシャルカードとどう見分けますか？",
             "a": "コミックパラレルは背景が漫画のコマになっているのが目印です。EB-02には同じルフィのスペシャルカード(買取約20万円)もあり、相場が1.75倍ほど違います。購入時はレアリティ表記と型番(コミパラはEB02-061)の両方を確認してください。"},
        ],
    },
    {'slug': 'round1-promo',
     'nav_label': 'ラウンドワン プロモ全10種',
     'crumb': 'ROUND1 プロモーションパック 当たりカード',
     'date': '2026-09-08',
     'date_jp': '2026年9月8日',
     'title': 'ラウンドワン ワンピカプロモ 当たりランキング全10種｜相場・入手方法・10月17日の配布終了まで',
     'h1': 'ラウンドワン ワンピカプロモ 当たりカードランキング全10種｜相場と入手方法',
     'meta_desc': 'ラウンドワン×ONE '
                  'PIECEコラボのROUND1プロモーションパック全10種の相場を2026年9月8日時点で更新。1位モンキー・D・ルフィは約¥6,999で、7月末の約¥34,000から-79%。直近1週間でも9種が下落しています。未開封パック(約¥2,240)と中身の期待値、全10種コンプに必要な約30パックの費用比較、10月17日の配布終了に向けた入手条件(1日5クーポン上限)まで実データで整理します。',
     'og_title': 'ラウンドワン ワンピカプロモ 全10種の当たりランキングと相場',
     'og_desc': '全10種の相場を9月8日時点に更新。1位ルフィ約¥6,999(7月末比-79%)。配布は10月17日まで。',
     'meta_line': 'ROUND1プロモ全10種の相場・入手方法・コンプ期待値',
     'hero_label': 'ROUND1 プロモーションパック 全10種の最高額',
     'hero_big': 'モンキー・D・ルフィ 約¥6,999',
     'hero_sub': '2位 ロロノア・ゾロ 約¥3,000 / 3位 ニコ・ロビン 約¥2,950 / 未開封パック '
                 '約¥2,240。<strong>1週間で全10種のうち9種が下落</strong>し、7月末比では-63〜-85%です。全10種はラウンドワン店舗のコラボメニュー購入でのみ入手でき、1パック1枚・全10種ランダム。配布は<strong>2026年10月17日(土)まで</strong>。相場はスニダン掲載の最安提示価格(2026年9月8日時点)。',
     'disclaimer': '本記事のカード相場は<strong>2026年9月8日時点でスニダン(SNKRDUNK)に出ている最安提示価格</strong>を基準にした目安で、当サイトがBOX買取価格で使用している基準(最大10店舗の買取実データ)とは別のものです。最安提示価格は実際の成約価格と一致しないことがあり、たとえばモンキー・D・ルフィは同時点の売買履歴が状態Aで¥15,500〜¥18,000と、最安提示より高い水準で成立しています。本プロモは<strong>2026年10月17日まで配布が継続中</strong>のため供給が増え続けており、相場は通常のパック以上に動きやすい状態です。配布条件は公式発表(ONE '
                   'PIECE.com)に基づきますが、店舗の在庫状況により異なる場合があります。売買の判断はご自身の責任で行ってください。',
     'related': '<li><a href="shikou-treasure-get.html">4周年！四皇トレジャーゲットキャンペーンパック 全7種</a> — もうひとつの配布系プロモの相場と期待値</li>\n'
                '<li><a href="kougaku-ranking.html">ワンピカード 高額BOXランキング・絶版ガイド</a> — 全弾のBOX買取価格を実データでランキング</li>\n'
                '<li><a href="comipara-ranking.html">歴代コミックパラレル相場ランキング全22弾</a> — カード単体の最高額ランキング</li>\n'
                '<li><a href="hatsubai-schedule.html">ワンピカード 新弾発売スケジュール</a> — 今後の発売予定と定価改定</li>\n'
                '<li><a href="kaitori-hikaku.html">ワンピBOX買取比較ガイド</a> — 高く売るコツと店舗選びの手順</li>\n'
                '<li><a href="/onepiece">ワンピBOX買取価格比較トップ</a> — 全弾のBOX買取価格を最大10店舗で横断比較</li>',
     'body': '<p><strong>「ONE PIECEカードゲーム -ROUND1 プロモーションパック-」</strong>は、ラウンドワンとONE '
             'PIECEのコラボキャンペーンで配布されているノベルティです。店舗でしか手に入らない<strong>完全オリジナル仕様の全10種</strong>で、麦わらの一味がボウリングやカラオケなどラウンドワンの施設で遊んでいる描き下ろしイラストが採用されています。</p>\n'
             '\n'
             '<div class="callout"><strong>3行まとめ:</strong><br>\n'
             '・最高額は<strong>モンキー・D・ルフィ(OP16-095)で約¥6,999</strong>、最安のフランキーは約¥1,500と<strong>4.7倍の開き</strong>(2026年9月8日時点)<br>\n'
             '・未開封パックは<strong>約¥2,240</strong>。中身10種の平均は約¥2,640で、<strong>パック代を上回るのは10種中4種</strong><br>\n'
             '・7月末から<strong>10種すべてが下落</strong>し、平均で<strong>約-79%</strong>。配布が<strong>10月17日まで続く</strong>のが供給面の要因</div>\n'
             '\n'
             '<h2>ROUND1 プロモーションパックとは</h2>\n'
             '<table class="price-table">\n'
             '<thead><tr><th>項目</th><th>内容</th></tr></thead>\n'
             '<tbody>\n'
             '<tr><td>名称</td><td>ONE PIECEカードゲーム -ROUND1 プロモーションパック-</td></tr>\n'
             '<tr><td>配布期間</td><td>2026年7月18日(土)〜10月17日(土)</td></tr>\n'
             '<tr><td>対象店舗</td><td>カード配布は国内98店舗(コラボ自体は国内100店舗で実施。町田ジョルナ店・調布駅前店はコラボメニューの販売なし)</td></tr>\n'
             '<tr><td>内容</td><td>1パック1枚・<strong>全10種ランダム</strong></td></tr>\n'
             '<tr><td>入手方法</td><td>ラウンドワンアプリのクーポン提示＋コラボメニュー購入</td></tr>\n'
             '<tr><td>枚数制限</td><td>クーポンは1人1日5枚まで(毎日午前6:00配布)、商品1個につきカード1枚</td></tr>\n'
             '</tbody>\n'
             '</table>\n'
             '\n'
             '<p>今回のコラボは<strong>日米同時開催</strong>で、国内100店舗と北米59店舗の<strong>計159店舗</strong>という規模で展開されています。このうちカードが配布されるのは、コラボメニューを扱う<strong>国内98店舗</strong>です(町田ジョルナ店・調布駅前店を除く)。日本語版のプロモカードはこの国内店舗で配布されているものです。</p>\n'
             '\n'
             '<h3>もらうための条件は2つ</h3>\n'
             '<p>公式発表によると、配布の条件は次の2つを<strong>同時に満たすこと</strong>です。</p>\n'
             '<ul>\n'
             '<li><strong>コラボメニューを購入する</strong> — アレンジドリンク、ポップコーン、ノベルティ付きドリンクが対象。購入にはラウンドワンアプリで配信されるクーポンが必要です</li>\n'
             '<li><strong>施設を利用している</strong> — ボウリング・スポッチャ・カラオケ・ビリヤード・ダーツのいずれかの利用者が対象です</li>\n'
             '</ul>\n'
             '<div class="callout"><strong>在庫切れ時:</strong> カードの在庫がない場合は「ノベルティ引換券」が配布され、後日交換できます。引換券の有効期限は告知後30日間とされています。</div>\n'
             '\n'
             '<h2>当たりカードランキング全10種｜相場一覧(2026年9月8日時点)</h2>\n'
             '<p>全10種をスニダンの最安提示価格で並べたものが以下の表です。<strong>1週間前(9月1日)から全種が動いており、順位も大きく入れ替わりました</strong>。</p>\n'
             '\n'
             '<table class="price-table">\n'
             '<thead><tr><th>順位</th><th>カード名</th><th>型番</th><th style="text-align:right">相場の目安</th></tr></thead>\n'
             '<tbody>\n'
             '<tr class="best"><td>1位</td><td><strong>モンキー・D・ルフィ</strong>(R)</td><td>OP16-095</td><td class="price"><strong>約¥6,999</strong></td></tr>\n'
             '<tr><td>2位</td><td>ロロノア・ゾロ(R)</td><td>PRB02-006</td><td class="price">約¥3,000</td></tr>\n'
             '<tr><td>3位</td><td>ニコ・ロビン(C)</td><td>EB03-054</td><td class="price">約¥2,950</td></tr>\n'
             '<tr><td>4位</td><td>ナミ(C)</td><td>ST29-008</td><td class="price">約¥2,700</td></tr>\n'
             '<tr><td>5位</td><td>ウソップ(UC)</td><td>OP11-003</td><td class="price">約¥2,200</td></tr>\n'
             '<tr><td>6位</td><td>ジンベエ(C)</td><td>ST29-005</td><td class="price">約¥1,850</td></tr>\n'
             '<tr><td>7位</td><td>ブルック(R)</td><td>OP11-056</td><td class="price">約¥1,800</td></tr>\n'
             '<tr><td>8位</td><td>サンジ(R)</td><td>OP15-047</td><td class="price">約¥1,700</td></tr>\n'
             '<tr><td>8位</td><td>トニートニー・チョッパー(UC)</td><td>OP09-068</td><td class="price">約¥1,700</td></tr>\n'
             '<tr><td>10位</td><td>フランキー(C)</td><td>ST21-011</td><td class="price">約¥1,500</td></tr>\n'
             '</tbody>\n'
             '</table>\n'
             '\n'
             '<p>10種の合計は<strong>約¥26,400</strong>、平均すると<strong>約¥2,640</strong>です。1位と10位の差は4.7倍(9月1日時点は7.6倍)まで縮まっており、通常のブースターパックにおけるコミパラとSRの差(数十〜数百倍)と比べると、<strong>格差はかなり緩やか</strong>といえます。全10種が麦わらの一味という構成上、極端な当たり外れが出にくい設計です。</p>\n'
             '\n'
             '<div class="callout"><strong>提示価格と成約価格は一致しません:</strong> '
             '表の金額はいずれも<strong>最安の提示価格</strong>です。人気カードほど安い出品から先に売れるため、実際に買うときは提示価格より高くつくことがあります。実例として、9月1日時点のルフィは最安提示が¥11,400だった一方、スニダンの売買履歴では<strong>状態Aで¥15,500〜¥18,000</strong>の成約が並んでいました。本記事は提示価格で統一しているので、購入前に売買履歴もあわせて確認してください。</div>\n'
             '\n'
             '<h2>未開封パック vs 中身｜開けるべきか</h2>\n'
             '<p>未開封パックの相場は<strong>約¥2,240</strong>(2026年9月8日時点)です。1週間で約¥1,800下がりました。これを中身10種の相場と突き合わせると、次のようになります。</p>\n'
             '\n'
             '<table class="price-table">\n'
             '<thead><tr><th>区分</th><th style="text-align:right">金額</th><th>内訳</th></tr></thead>\n'
             '<tbody>\n'
             '<tr><td>未開封パック</td><td class="price">約¥2,240</td><td>1パック1枚</td></tr>\n'
             '<tr class="best"><td><strong>中身の平均(期待値)</strong></td><td class="price"><strong>約¥2,640</strong></td><td>全10種が等確率と仮定</td></tr>\n'
             '<tr><td>パック代を上回るカード</td><td class="price">4種</td><td>ルフィ・ゾロ・ロビン・ナミ</td></tr>\n'
             '<tr><td>パック代を下回るカード</td><td class="price">6種</td><td>ウソップ・ジンベエ・ブルック・サンジ・チョッパー・フランキー</td></tr>\n'
             '</tbody>\n'
             '</table>\n'
             '\n'
             '<p>期待値は<strong>パック代を約¥400上回る</strong>計算ですが、これは<strong>ルフィ1種が平均を押し上げているだけ</strong>です。パック代を上回るのは10種中4種で、<strong>6種は引いた時点でパック代割れ</strong>します。実際には売買手数料や送料が乗るため、<strong>ルフィを引かない限り開封で得をするのは難しい</strong>という構図は変わっていません。</p>\n'
             '<div class="callout"><strong>結論:</strong> 狙いのキャラが決まっているなら<strong>シングルで買うほうが確実</strong>です。未開封のまま持つ意味があるのは、配布終了後の希少性に賭ける場合に限られます。同じ判断が必要になる配布系プロモとして、<a '
             'href="shikou-treasure-get.html">4周年！四皇トレジャーゲットキャンペーンパック</a>も参考になります。</div>\n'
             '\n'
             '<h2>全10種をそろえるには約30パック必要</h2>\n'
             '<p>全10種をランダム配布でコンプリートするために必要なパック数は、確率論の「クーポンコレクター問題」で計算できます。10種が等確率で出ると仮定した場合の期待値は次のとおりです。</p>\n'
             '<p style="text-align:center;font-weight:700;font-size:16px">10 × (1 + 1/2 + 1/3 + … + 1/10) ≒ <strong>29.3パック</strong></p>\n'
             '<p>つまり<strong>平均で約30パック</strong>、運が悪ければそれ以上が必要になります。クーポンは1人1日5枚までなので、<strong>最短でも6日間の来店</strong>が必要な計算です。</p>\n'
             '<div class="callout"><strong>現地で集める vs シングルで買う:</strong> '
             '30パックを市場価格(¥2,240)で買い集めると<strong>約6万7千円</strong>。一方、10種をシングルで1枚ずつ買えば<strong>約2万6千円</strong>で済みます。<strong>コンプ目的なら、パックを買い集めるより2.5倍安い</strong>という結論になります。逆にラウンドワンで遊びながら現地でもらうなら、実質的な負担はコラボメニュー代だけです。</div>\n'
             '\n'
             '<h2>7月末からの下落｜10種すべてが値下がり</h2>\n'
             '<p>このプロモの相場は、配布開始から大きく動き続けています。スニダンが2026年7月27日に掲載した相場と、9月1日・9月8日の時点を並べると次のとおりです。</p>\n'
             '\n'
             '<table class="price-table">\n'
             '<thead><tr><th>カード</th><th style="text-align:right">7月27日</th><th style="text-align:right">9月1日</th><th style="text-align:right">9月8日</th><th '
             'style="text-align:right">7/27比</th></tr></thead>\n'
             '<tbody>\n'
             '<tr class="best"><td><strong>ルフィ</strong></td><td class="price">約¥34,000</td><td class="price">約¥11,400</td><td class="price">約¥6,999</td><td class="price" '
             'style="color:#b91c1c;font-weight:700">-79%</td></tr>\n'
             '<tr><td>ゾロ</td><td class="price">約¥15,000</td><td class="price">約¥3,800</td><td class="price">約¥3,000</td><td class="price" style="color:#b91c1c;font-weight:700">-80%</td></tr>\n'
             '<tr><td>ロビン</td><td class="price">約¥12,000</td><td class="price">約¥5,550</td><td class="price">約¥2,950</td><td class="price" style="color:#b91c1c;font-weight:700">-75%</td></tr>\n'
             '<tr><td>ナミ</td><td class="price">約¥15,000</td><td class="price">約¥5,700</td><td class="price">約¥2,700</td><td class="price" style="color:#b91c1c;font-weight:700">-82%</td></tr>\n'
             '<tr><td>ウソップ</td><td class="price">約¥6,000</td><td class="price">約¥1,500</td><td class="price">約¥2,200</td><td class="price" style="color:#b91c1c;font-weight:700">-63%</td></tr>\n'
             '<tr><td>ジンベエ</td><td class="price">約¥8,000</td><td class="price">約¥2,000</td><td class="price">約¥1,850</td><td class="price" style="color:#b91c1c;font-weight:700">-77%</td></tr>\n'
             '<tr><td>ブルック</td><td class="price">約¥10,000</td><td class="price">約¥4,500</td><td class="price">約¥1,800</td><td class="price" style="color:#b91c1c;font-weight:700">-82%</td></tr>\n'
             '<tr><td>サンジ</td><td class="price">約¥11,000</td><td class="price">約¥4,500</td><td class="price">約¥1,700</td><td class="price" style="color:#b91c1c;font-weight:700">-85%</td></tr>\n'
             '<tr><td>チョッパー</td><td class="price">約¥10,000</td><td class="price">約¥3,666</td><td class="price">約¥1,700</td><td class="price" style="color:#b91c1c;font-weight:700">-83%</td></tr>\n'
             '<tr><td>フランキー</td><td class="price">約¥8,000</td><td class="price">約¥3,900</td><td class="price">約¥1,500</td><td class="price" style="color:#b91c1c;font-weight:700">-81%</td></tr>\n'
             '</tbody>\n'
             '</table>\n'
             '\n'
             '<p>10種の合計は約¥129,000から約¥26,400へ、<strong>平均で約-79%</strong>。7月末と比べれば例外は1枚もありません。</p>\n'
             '<h3>下落の理由は「配布が続いていること」</h3>\n'
             '<p>通常のブースターパックは発売と同時に供給がほぼ確定しますが、<strong>配布系プロモは期間中ずっと供給が増え続けます</strong>。今回は7月18日から10月17日までの3か月間、98店舗で毎日クーポンが配られ続けるため、市場に出回る枚数は日々増えていきます。発売直後の品薄で付いた初動価格が、配布が進むにつれて実勢に収束していく——これが配布系プロモに共通する値動きの型です。</p>\n'
             '<p>同じ構造は<a href="shikou-treasure-get.html">四皇トレジャーゲットキャンペーンパック</a>でも観測されており、<strong>初動の高値は「まだ枚数が出ていない時期の価格」</strong>と理解しておくと判断を誤りにくくなります。</p>\n'
             '<h3>配布終了後は上がるのか</h3>\n'
             '<p>直近1週間(9月1日→9月8日)でも<strong>全10種のうち9種が下げ続けており、ルフィは-39%、サンジとフランキーは-62%</strong>と下落が止まっていません。例外は<strong>ウソップだけで、¥1,500から¥2,200へ+47%</strong>と逆行しています(最安値圏まで下げた反動とみられますが、断定はできません)。</p>\n'
             '<p>断定はできませんが、供給が止まるのは10月17日です。それ以降は新規の枚数が増えないため、<strong>下落圧力そのものは弱まる</strong>と考えられます。ただし、すでに市場に出た枚数が減るわけではないので、旧弾BOXのように「開封で在庫が自然減する」タイプの上昇要因は働きません。実際、直近1週間は配布が続いているなかで9種が下げており、<strong>終了が近いこと自体は買い材料になっていない</strong>のが現状です。</p>\n'
             '\n'
             '<h2>英語版は日本語版より高い</h2>\n'
             '<p>このプロモには<strong>英語版</strong>も存在し、スニダンでは日本語版とは別の商品として扱われています。2026年9月8日時点の最安提示価格は、確認できた範囲で<strong>¥13,000〜¥15,000</strong>でした。</p>\n'
             '<table class="price-table">\n'
             '<thead><tr><th>カード</th><th style="text-align:right">日本語版</th><th style="text-align:right">英語版</th><th style="text-align:right">差</th></tr></thead>\n'
             '<tbody>\n'
             '<tr class="best"><td>ナミ</td><td class="price">約¥2,700</td><td class="price">約¥15,000</td><td class="price">約5.6倍</td></tr>\n'
             '<tr><td>ニコ・ロビン</td><td class="price">約¥2,950</td><td class="price">約¥13,000</td><td class="price">約4.4倍</td></tr>\n'
             '<tr><td>サンジ</td><td class="price">約¥1,700</td><td class="price">約¥13,000</td><td class="price">約7.6倍</td></tr>\n'
             '</tbody>\n'
             '</table>\n'
             '<p>日本語版が下落を続けるなかで英語版がこの水準にあるのは、<strong>日本国内での配布が圧倒的に多く、海外版の流通量が限られている</strong>ためと考えられます。ただし英語版は取引数そのものが少なく、提示価格が成約価格と離れやすい点には注意が必要です。日本語版の相場をそのまま当てはめて判断しないでください。</p>\n'
             '\n'
             '<h2>配布終了(10月17日)まで残りわずか</h2>\n'
             '<p>コラボキャンペーンは<strong>2026年7月18日(土)〜10月17日(土)</strong>で、<strong>数量限定・なくなり次第終了</strong>です。店舗の在庫が尽きればその時点で配布が終わります。</p>\n'
             '<div class="callout"><strong>公式が示している入手条件</strong>(ONE PIECE公式サイトのお知らせより)\n'
             '<ul>\n'
             '<li><strong>ボウリング・スポッチャ・カラオケ・ビリヤード・ダーツのいずれかを利用している人</strong>だけがコラボメニューを購入できます</li>\n'
             '<li>ラウンドワンアプリの<strong>クーポンが必須</strong>(毎日午前6:00配布・<strong>1日5枚まで</strong>)</li>\n'
             '<li><strong>1クーポン＝1商品購入＝カード1枚</strong></li>\n'
             '<li>在庫切れの場合は<strong>ノベルティ引換券</strong>が配布され、後日交換できます</li>\n'
             '<li><strong>転売目的の買い占め等は固くお断り</strong>と明記されています。クーポンは本人のみ使用可能で、複数アカウントの利用は禁止です</li>\n'
             '</ul></div>\n'
             '<p>1日5枚が上限なので、<strong>全10種のコンプに必要な約30パックを現地で集めるには最低6日間の来店</strong>が必要です。これに毎回の施設利用料とコラボメニュー代が加わります。</p>\n'
             '<p>なお公式は<strong>転売目的の買い占めを禁止</strong>しており、クーポンは本人のみ使用可・複数アカウントの利用も不可です。規定の上限を超えるとノベルティの提供自体が制限される可能性があるため、<strong>まとめ取りを狙うとかえって手に入らなくなります</strong>。現地で数を集めるより、足りない分はシングルで買うほうが結果的に安く早いのは前述のとおりです。</p>\n'
             '\n'
             '<h2>入手・売買の注意点</h2>\n'
             '<ul>\n'
             '<li><strong>クーポンは1日5枚が上限</strong> — まとめ買いはできません。コンプを狙うなら複数日の来店が前提になります</li>\n'
             '<li><strong>施設利用が条件</strong> — コラボメニューだけを買うことはできず、ボウリングなどの利用が必要です</li>\n'
             '<li><strong>10月17日で配布終了</strong> — 現地で入手できるのは期間内だけです</li>\n'
             '<li><strong>状態の管理に注意</strong> — 配布品はスリーブに入っていないため、持ち帰り時の折れ・傷が価格に直結します。高額なルフィほど影響は大きくなります</li>\n'
             '<li><strong>売るときは複数の販路を比較</strong> — 提示価格と成約価格に開きがあるカードのため、フリマ・買取店・スニダンで水準が異なります。<a href="kaitori-hikaku.html">買取比較ガイド</a>の考え方がそのまま使えます</li>\n'
             '</ul>',
     'faq': [{'q': 'ラウンドワンのワンピースカードプロモはどうやってもらえますか？',
              'a': 'ラウンドワンアプリで配信されるクーポンを提示してコラボメニュー(アレンジドリンク・ポップコーン・ノベルティ付きドリンク)を購入し、かつボウリング・スポッチャ・カラオケ・ビリヤード・ダーツのいずれかを利用している方が対象です。クーポンは1人1日5枚まで(毎日午前6:00配布)で、商品1個につきカード1枚がもらえます。配布期間は2026年7月18日〜10月17日、国内98店舗が対象です。'},
             {'q': 'ROUND1プロモで一番高いカードはどれですか？',
              'a': 'モンキー・D・ルフィ(OP16-095)で、2026年9月8日時点の相場は約¥6,999です。2位はロロノア・ゾロ(PRB02-006)の約¥3,000、3位はニコ・ロビン(EB03-054)の約¥2,950と続きます。最安はフランキーの約¥1,500で、1位との差は約4.7倍です。7月末は約¥34,000だったため、約1か月半で-79%まで下げています。'},
             {'q': '全10種そろえるには何パック必要ですか？',
              'a': '10種が等確率で出ると仮定すると、平均で約29.3パック——およそ30パックが必要です。クーポンは1人1日5枚までのため、最短でも6日間の来店が必要になります。市場で30パック買い集めると約6万7千円かかるのに対し、10種をシングルで買えば約2万6千円で済むため、コンプ目的ならシングル購入のほうが2.5倍安い計算です。'},
             {'q': 'パックのまま売るのと開封するのはどちらが得ですか？', 'a': '未開封パックが約¥2,240、中身10種の平均が約¥2,640なので、期待値は約¥400のプラスです。ただしこれはルフィ1種が平均を押し上げているためで、パック代を上回るのは10種中4種のみ。売買手数料や送料を考えると、ルフィを引かない限り開封で得をするのは難しい構図です。'},
             {'q': '配布が終わったら値上がりしますか？',
              'a': '断定はできません。10月17日で配布が終わると新規の供給は止まるため、下落圧力は弱まると考えられます。ただし、すでに出回った枚数が減るわけではないので、未開封BOXのように「開封で在庫が自然減する」タイプの上昇要因は働きません。7月末から9月1日までに10種すべてが平均約64%下落しており、配布系プロモは供給が読みやすいぶん値動きも実勢に収束しやすい点を踏まえて判断してください。'}]},
]
...
# Amazonで招待リクエスト(抽選)を受け付けている弾。2026-09-12に全ASINを実地で確認した。
# ASINは商品ページのIDなので、招待受付が終わっても通常販売ページとして生きる(死にリンクにならない)。
AMAZON_INVITE_CHECKED = "2026年9月12日"
AMAZON_INVITE = [
    ("B0HFVPJF4Q", "OP-18"),
    ("B0HB3JQ6P4", "EB-05"),
    ("B0FJ7Z6RML", "EB-03"),
...
def _howto_placeholders(body: str, box: dict) -> str:
    body = AZ_RE.sub(lambda m: _amazon_dp(m.group(1)), body)
...
def _positioning_section(a: dict, articles: list, box: dict) -> str:
    ...
    return f"""
<h2>全弾で見た本弾の位置づけ</h2>
<p>ワンピースカードの全弾を横断して、本弾がどの位置にあるかを整理します。カード相場は当たりカードのコミックパラレル最高額、BOX買取は当サイトが最大10店舗から毎日自動取得している実データです。</p>
<table class="price-table">
...
<a href="box/{slug}.html" class="cta">{_esc(a['box_name'])}の最新買取価格を最大10店舗で比較する &rarr;</a>
...
<li><a href="/onepiece">ワンピBOX買取価格比較トップ</a> — 全23種のBOX買取価格を最大10店舗で横断比較</li>
...
def _render_howto(h: dict, atari_articles: list, box: dict | None = None) -> str:
    ...
    disclaimer_html = h.get(
        ...
        "BOX買取価格は当サイトが最大10店舗から自動取得した実データを基準にしていますが、"
        "実際の売却時は各店の公式ページで最終価格をご確認ください。売買の判断はご自身の責任で行ってください。")
    related_html = h.get(
        "related",
        '<li><a href="/onepiece">ワンピBOX買取価格比較トップ</a> — 全弾のBOX買取価格を最大10店舗で横断比較(毎日更新)</li>\n'
        '<li><a href="weekly.html">週間値動きランキング</a> — 直近7日間で値上がり・値下がりしたBOXを毎日自動更新</li>\n'
...
<a href="/onepiece" class="cta">ワンピBOXの最新買取価格を最大10店舗で比較する &rarr;</a>
