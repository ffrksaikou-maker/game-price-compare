...
ONEPIECE_ARTICLES.append(
    ("round1-promo.html", "ラウンドワン プロモ全10種",
     "10/17まで配布中のROUND1プロモ全10種の相場。1位ルフィ約1.1万、7月末比で10種すべてが平均64%下落。"))
...
_WK_AFFILIATE = (
    ...
    '<div class="ad" style="text-align:center;padding:12px 0">'
    '<a href="https://px.a8.net/svt/ejp?a8mat=4BCFNO+BB8IK2+5W1M+BXB8X" rel="nofollow">'
    '<img src="https://www29.a8.net/svt/bgt?aid=260920644684&wid=001&eno=01&mid=s00000027481002003000&mc=1" alt="ふるいち トレカ宅配買取" border="0" width="300" height="250" loading="lazy" decoding="async" style="max-width:100%;height:auto"></a>'
    '<img src="https://www13.a8.net/0.gif?a8mat=4BCFNO+BB8IK2+5W1M+BXB8X" alt="" border="0" width="1" height="1"></div>'
)
